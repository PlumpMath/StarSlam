...
Void Input_obj::gamepad_add( int id){
{
		HX_STACK_FRAME("snow.core.native.input.Input","gamepad_add",0xd62efd48,"snow.core.native.input.Input.gamepad_add","snow/core/native/input/Input.hx",27,0x3a301f0d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_LINE(27)
		int tmp = id;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(27)
		::snow::core::native::input::Input_obj::snow_gamepad_open(tmp);
	}
return null();
}


HX_DEFINE_DYNAMIC_FUNC1(Input_obj,gamepad_add,(void))

Void Input_obj::gamepad_remove( int id){
{
		HX_STACK_FRAME("snow.core.native.input.Input","gamepad_remove",0x8ae3c37d,"snow.core.native.input.Input.gamepad_remove","snow/core/native/input/Input.hx",29,0x3a301f0d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(id,"id")
		HX_STACK_LINE(29)
		int tmp = id;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(29)
		::snow::core::native::input::Input_obj::snow_gamepad_close(tmp);
	}
return null();
}


HX_DEFINE_DYNAMIC_FUNC1(Input_obj,gamepad_remove,(void))

Void Input_obj::text_input_start( ){
{
		HX_STACK_FRAME("snow.core.native.input.Input","text_input_start",0xbfe11a36,"snow.core.native.input.Input.text_input_start","snow/core/native/input/Input.hx",33,0x3a301f0d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(33)
...
{
		HX_STACK_FRAME("snow.core.native.input.Input","text_input_stop",0x5dd8e0ae,"snow.core.native.input.Input.text_input_stop","snow/core/native/input/Input.hx",35,0x3a301f0d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(35)
...
{
		HX_STACK_FRAME("snow.core.native.input.Input","text_input_rect",0x5d243dd0,"snow.core.native.input.Input.text_input_rect","snow/core/native/input/Input.hx",37,0x3a301f0d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		HX_STACK_ARG(w,"w")
...
Dynamic Input_obj::snow_gamepad_open;

Dynamic Input_obj::snow_gamepad_close;
...
bool Input_obj::__GetStatic(const ::String &inName, Dynamic &outValue, hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 17:
		if (HX_FIELD_EQ(inName,"snow_gamepad_open") ) { outValue = snow_gamepad_open; return true;  }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"snow_gamepad_close") ) { outValue = snow_gamepad_close; return true;  }
		break;
	case 20:
...
bool Input_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 17:
		if (HX_FIELD_EQ(inName,"snow_gamepad_open") ) { snow_gamepad_open=ioValue.Cast< Dynamic >(); return true; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"snow_gamepad_close") ) { snow_gamepad_close=ioValue.Cast< Dynamic >(); return true; }
		break;
	case 20:
...
static hx::StaticInfo sStaticStorageInfo[] = {
	...
	{hx::fsObject /*Dynamic*/ ,(void *) &Input_obj::snow_gamepad_open,HX_HCSTRING("snow_gamepad_open","\xe4","\xf1","\xbb","\x85")},
	{hx::fsObject /*Dynamic*/ ,(void *) &Input_obj::snow_gamepad_close,HX_HCSTRING("snow_gamepad_close","\x5e","\x80","\x4b","\x93")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
static ::String sMemberFields[] = {
	...
	HX_HCSTRING("gamepad_add","\x43","\x7c","\x8e","\xe4"),
	HX_HCSTRING("gamepad_remove","\x62","\x93","\xaf","\x70"),
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(Input_obj::snow_gamepad_open,"snow_gamepad_open");
	HX_MARK_MEMBER_NAME(Input_obj::snow_gamepad_close,"snow_gamepad_close");
};
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(Input_obj::snow_gamepad_open,"snow_gamepad_open");
	HX_VISIT_MEMBER_NAME(Input_obj::snow_gamepad_close,"snow_gamepad_close");
};
...
static ::String sStaticFields[] = {
	...
	HX_HCSTRING("snow_gamepad_open","\xe4","\xf1","\xbb","\x85"),
	HX_HCSTRING("snow_gamepad_close","\x5e","\x80","\x4b","\x93"),
	::String(null()) };
...
void Input_obj::__boot()
{
	...
	snow_gamepad_open= ::snow::api::Libs_obj::load(HX_HCSTRING("snow","\x83","\x62","\x57","\x4c"),HX_HCSTRING("snow_gamepad_open","\xe4","\xf1","\xbb","\x85"),(int)1);
	snow_gamepad_close= ::snow::api::Libs_obj::load(HX_HCSTRING("snow","\x83","\x62","\x57","\x4c"),HX_HCSTRING("snow_gamepad_close","\x5e","\x80","\x4b","\x93"),(int)1);
}
