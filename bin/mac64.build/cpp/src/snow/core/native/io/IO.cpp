...
int _slot = __o__slot.Default(0);
	HX_STACK_FRAME("snow.core.native.io.IO","string_slot_save",0x0c1f98e3,"snow.core.native.io.IO.string_slot_save","snow/core/native/io/IO.hx",195,0x990c4183)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_slot,"_slot")
	HX_STACK_ARG(_contents,"_contents")
{
		...
		HX_STACK_LINE(198)
		::String tmp2 = _contents;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(198)
		::haxe::io::Bytes tmp3 = ::haxe::io::Bytes_obj::ofString(tmp2);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(198)
		::snow::api::buffers::ArrayBufferView tmp4 = ::snow::api::buffers::_Uint8Array::Uint8Array_Impl__obj::fromBytes(tmp3,null(),null());		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(198)
		::snow::api::buffers::ArrayBufferView _data = tmp4;		HX_STACK_VAR(_data,"_data");
		HX_STACK_LINE(200)
		::String tmp5 = _path;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(200)
		::snow::api::buffers::ArrayBufferView tmp6 = _data;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(200)
		bool tmp7 = this->data_save(tmp5,tmp6,null());		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(200)
		return tmp7;
	}
}
...
int _slot = __o__slot.Default(0);
	HX_STACK_FRAME("snow.core.native.io.IO","string_slot_load",0x0789a7cc,"snow.core.native.io.IO.string_slot_load","snow/core/native/io/IO.hx",206,0x990c4183)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_slot,"_slot")
{
		HX_STACK_LINE(208)
		...
		HX_STACK_LINE(214)
		::haxe::io::Bytes tmp5 = ::snow::api::buffers::_Uint8Array::Uint8Array_Impl__obj::toBytes(tmp4);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(214)
...
::String IO_obj::string_slot_encode( ::String _string){
	HX_STACK_FRAME("snow.core.native.io.IO","string_slot_encode",0xdc91353c,"snow.core.native.io.IO.string_slot_encode","snow/core/native/io/IO.hx",218,0x990c4183)
	HX_STACK_THIS(this)
...
::String IO_obj::string_slot_decode( ::String _string){
	HX_STACK_FRAME("snow.core.native.io.IO","string_slot_decode",0x479aa054,"snow.core.native.io.IO.string_slot_decode","snow/core/native/io/IO.hx",224,0x990c4183)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_string,"_string")
	HX_STACK_LINE(225)
	{
...
::snow::api::buffers::ArrayBufferView IO_obj::_data_load( ::String _path,Dynamic _options){
	HX_STACK_FRAME("snow.core.native.io.IO","_data_load",0x09fbffcf,"snow.core.native.io.IO._data_load","snow/core/native/io/IO.hx",231,0x990c4183)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_path,"_path")
	HX_STACK_ARG(_options,"_options")
	HX_STACK_LINE(233)
...
bool IO_obj::isAbsolute( ::String path){
	HX_STACK_FRAME("snow.core.native.io.IO","isAbsolute",0x3f139cf4,"snow.core.native.io.IO.isAbsolute","snow/core/native/io/IO.hx",259,0x990c4183)
...
::String IO_obj::path_resolve( ::String _path){
	HX_STACK_FRAME("snow.core.native.io.IO","path_resolve",0xec3cfe45,"snow.core.native.io.IO.path_resolve","snow/core/native/io/IO.hx",266,0x990c4183)
	HX_STACK_ARG(_path,"_path")
	HX_STACK_LINE(268)
	::String tmp = _path;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(268)
