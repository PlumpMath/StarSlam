...
Dynamic Assets_obj::audio_load_ogg_from_bytes( ::String _path,::snow::api::buffers::ArrayBufferView _bytes){
	...
	int tmp2 = _bytes->byteLength;		HX_STACK_VAR(tmp2,"tmp2");
	struct _Function_1_1{
		inline static Array< unsigned char > Block( ::snow::api::buffers::ArrayBufferView &_bytes){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","snow/core/native/assets/Assets.hx",241,0x2669b743)
			{
				HX_STACK_LINE(241)
				::snow::api::buffers::ArrayBufferView tmp3 = _bytes;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(241)
				::haxe::io::Bytes tmp4 = ::snow::api::buffers::_Uint8Array::Uint8Array_Impl__obj::toBytes(tmp3);		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(241)
				::haxe::io::Bytes _this = tmp4;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(241)
				return _this->b;
			}
			return null();
	...
	HX_STACK_LINE(241)
	Dynamic tmp3 = ::snow::core::native::assets::Assets_obj::snow_assets_audio_load_info_ogg(tmp,true,_Function_1_1::Block(_bytes),tmp1,tmp2);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(241)
	return tmp3;
}
...
Dynamic Assets_obj::audio_load_wav_from_bytes( ::String _path,::snow::api::buffers::ArrayBufferView _bytes){
	...
	struct _Function_1_1{
		inline static Array< unsigned char > Block( ::snow::api::buffers::ArrayBufferView &_bytes){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","snow/core/native/assets/Assets.hx",259,0x2669b743)
			{
				HX_STACK_LINE(259)
				::snow::api::buffers::ArrayBufferView tmp3 = _bytes;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(259)
	...
	HX_STACK_LINE(259)
	Dynamic tmp3 = ::snow::core::native::assets::Assets_obj::snow_assets_audio_load_info_wav(tmp,true,_Function_1_1::Block(_bytes),tmp1,tmp2);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(259)
	return tmp3;
}
...
Dynamic Assets_obj::audio_load_pcm_from_bytes( ::String _path,::snow::api::buffers::ArrayBufferView _bytes){
	...
	struct _Function_1_1{
		inline static Array< unsigned char > Block( ::snow::api::buffers::ArrayBufferView &_bytes){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","snow/core/native/assets/Assets.hx",277,0x2669b743)
			{
				HX_STACK_LINE(277)
				::snow::api::buffers::ArrayBufferView tmp3 = _bytes;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(277)
	...
	HX_STACK_LINE(277)
	Dynamic tmp3 = ::snow::core::native::assets::Assets_obj::snow_assets_audio_load_info_pcm(tmp,true,_Function_1_1::Block(_bytes),tmp1,tmp2);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(277)
	return tmp3;
}
