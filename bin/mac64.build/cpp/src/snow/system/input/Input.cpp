...
Void Input_obj::dispatch_gamepad_device_event( int gamepad,int type,Float timestamp){
{
		...
		Float tmp3 = timestamp;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(333)
		tmp->host->ongamepaddevice(tmp1,tmp2,tmp3);
	}
return null();
}
...
{
		HX_STACK_FRAME("snow.system.input.Input","on_gamepad_added",0x0971c55e,"snow.system.input.Input.on_gamepad_added","snow/system/input/Input.hx",363,0x35f6b58d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_event,"_event")
		HX_STACK_LINE(363)
		int id = _event->__Field(HX_HCSTRING("which","\xdd","\x3b","\xbd","\xc9"), hx::paccDynamic );		HX_STACK_VAR(id,"id");
		HX_STACK_LINE(363)
...
{
		HX_STACK_FRAME("snow.system.input.Input","on_gamepad_removed",0xfc01f3be,"snow.system.input.Input.on_gamepad_removed","snow/system/input/Input.hx",370,0x35f6b58d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_event,"_event")
		HX_STACK_LINE(370)
		int id = _event->__Field(HX_HCSTRING("which","\xdd","\x3b","\xbd","\xc9"), hx::paccDynamic );		HX_STACK_VAR(id,"id");
...
{
		HX_STACK_FRAME("snow.system.input.Input","update",0xd12d6b65,"snow.system.input.Input.update","snow/system/input/Input.hx",375,0x35f6b58d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(377)
		::snow::modules::sdl::Input tmp = this->module;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(377)
...
{
		HX_STACK_FRAME("snow.system.input.Input","destroy",0xbd46f81e,"snow.system.input.Input.destroy","snow/system/input/Input.hx",386,0x35f6b58d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(388)
		::snow::modules::sdl::Input tmp = this->module;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(388)
...
{
		HX_STACK_FRAME("snow.system.input.Input","_update_mousestate",0xde99ff9f,"snow.system.input.Input._update_mousestate","snow/system/input/Input.hx",395,0x35f6b58d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(397)
		::haxe::ds::IntMap tmp = this->mouse_button_pressed;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(397)
...
{
		HX_STACK_FRAME("snow.system.input.Input","_update_gamepadstate",0x96c90e63,"snow.system.input.Input._update_gamepadstate","snow/system/input/Input.hx",420,0x35f6b58d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(422)
		::haxe::ds::IntMap tmp = this->gamepad_button_pressed;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(422)
...
{
		HX_STACK_FRAME("snow.system.input.Input","_update_keystate",0x7c3b8725,"snow.system.input.Input._update_keystate","snow/system/input/Input.hx",449,0x35f6b58d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(454)
		::haxe::ds::IntMap tmp = this->key_code_pressed;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(454)
...
static ::String sMemberFields[] = {
	...
	HX_HCSTRING("on_gamepad_added","\x02","\x15","\xab","\xa2"),
	HX_HCSTRING("on_gamepad_removed","\x62","\x74","\xe9","\x51"),
