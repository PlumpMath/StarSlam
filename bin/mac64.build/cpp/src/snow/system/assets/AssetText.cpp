...
::snow::api::Promise AssetText_obj::processor( ::snow::Snow _app,::String _id,::snow::api::buffers::ArrayBufferView _data){
	...
	HX_STACK_LINE(286)
	::snow::api::buffers::ArrayBufferView tmp1 = _data;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(286)
	::haxe::io::Bytes tmp2 = ::snow::api::buffers::_Uint8Array::Uint8Array_Impl__obj::toBytes(tmp1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(286)
	::String tmp3 = tmp2->toString();		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(286)
	::snow::api::Promise tmp4 = ::snow::api::Promise_obj::resolve(tmp3);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(286)
	return tmp4;
}
