...
{
		HX_STACK_FRAME("snow.api.Promises","step",0x23521563,"snow.api.Promises.step","snow/api/Promise.hx",415,0xcb181004)
		HX_STACK_LINE(417)
...
{
		HX_STACK_FRAME("snow.api.Promises","next",0x1ff8b30a,"snow.api.Promises.next","snow/api/Promise.hx",427,0xcb181004)
		HX_STACK_LINE(428)
...
{
		HX_STACK_FRAME("snow.api.Promises","defer",0x1794737b,"snow.api.Promises.defer","snow/api/Promise.hx",432,0xcb181004)
		HX_STACK_ARG(f,"f")
		HX_STACK_ARG(a,"a")
		HX_STACK_LINE(433)
		...
		struct _Function_1_1{
			inline static Dynamic Block( Dynamic &f,Dynamic &a){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","snow/api/Promise.hx",434,0xcb181004)
				{
...
{
		HX_STACK_FRAME("snow.api.Promises","queue",0x9e5cb39a,"snow.api.Promises.queue","snow/api/Promise.hx",438,0xcb181004)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(439)
		bool tmp = (f == null());		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(439)
