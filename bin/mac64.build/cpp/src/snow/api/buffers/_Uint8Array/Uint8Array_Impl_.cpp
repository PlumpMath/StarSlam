...
::snow::api::buffers::ArrayBufferView Uint8Array_Impl__obj::subarray( ::snow::api::buffers::ArrayBufferView this1,int begin,Dynamic end){
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","subarray",0xc756a0fe,"snow.api.buffers._Uint8Array.Uint8Array_Impl_.subarray","snow/api/buffers/Uint8Array.hx",96,0xd9e22306)
...
::snow::api::buffers::ArrayBufferView Uint8Array_Impl__obj::fromBytes( ::haxe::io::Bytes bytes,Dynamic __o_byteOffset,Dynamic len){
Dynamic byteOffset = __o_byteOffset.Default(0);
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","fromBytes",0x8ceeee1c,"snow.api.buffers._Uint8Array.Uint8Array_Impl_.fromBytes","snow/api/buffers/Uint8Array.hx",100,0xd9e22306)
	...
	HX_STACK_ARG(len,"len")
{
		...
		HX_STACK_LINE(101)
		{
			...
			if ((tmp1)){
				HX_STACK_LINE(101)
				::snow::api::buffers::ArrayBufferView tmp2 = ::snow::api::buffers::ArrayBufferView_obj::__new(null(),(int)4);		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(101)
				this1 = tmp2;
			}
			else{
				...
				if ((tmp2)){
					...
					{
						HX_STACK_LINE(101)
						::snow::api::buffers::ArrayBufferView tmp4 = ::snow::api::buffers::ArrayBufferView_obj::__new((int)0,(int)4);		HX_STACK_VAR(tmp4,"tmp4");
						HX_STACK_LINE(101)
					...
					if ((tmp3)){
						...
						{
							HX_STACK_LINE(101)
							::snow::api::buffers::ArrayBufferView tmp5 = ::snow::api::buffers::ArrayBufferView_obj::__new((int)0,(int)4);		HX_STACK_VAR(tmp5,"tmp5");
							HX_STACK_LINE(101)
						...
						if ((tmp4)){
							...
							{
								HX_STACK_LINE(101)
								::snow::api::buffers::ArrayBufferView tmp6 = ::snow::api::buffers::ArrayBufferView_obj::__new((int)0,(int)4);		HX_STACK_VAR(tmp6,"tmp6");
								HX_STACK_LINE(101)
...
::haxe::io::Bytes Uint8Array_Impl__obj::toBytes( ::snow::api::buffers::ArrayBufferView this1){
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","toBytes",0x9b0aebab,"snow.api.buffers._Uint8Array.Uint8Array_Impl_.toBytes","snow/api/buffers/Uint8Array.hx",104,0xd9e22306)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(105)
...
::String Uint8Array_Impl__obj::toString( ::snow::api::buffers::ArrayBufferView this1){
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","toString",0xf8441d91,"snow.api.buffers._Uint8Array.Uint8Array_Impl_.toString","snow/api/buffers/Uint8Array.hx",110,0xd9e22306)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(110)
	::String tmp = (HX_HCSTRING("Uint8Array [byteLength:","\xb6","\x7b","\x69","\x5e") + this1->byteLength);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(110)
...
int Uint8Array_Impl__obj::get_length( ::snow::api::buffers::ArrayBufferView this1){
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","get_length",0xe8fd14d4,"snow.api.buffers._Uint8Array.Uint8Array_Impl_.get_length","snow/api/buffers/Uint8Array.hx",112,0xd9e22306)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(112)
...
Dynamic Uint8Array_Impl__obj::__get( ::snow::api::buffers::ArrayBufferView this1,int idx){
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","__get",0xa060c371,"snow.api.buffers._Uint8Array.Uint8Array_Impl_.__get","snow/api/buffers/Uint8Array.hx",117,0xd9e22306)
	HX_STACK_ARG(this1,"this1")
...
int Uint8Array_Impl__obj::__set( ::snow::api::buffers::ArrayBufferView this1,int idx,int val){
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","__set",0xa069de7d,"snow.api.buffers._Uint8Array.Uint8Array_Impl_.__set","snow/api/buffers/Uint8Array.hx",123,0xd9e22306)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(idx,"idx")
