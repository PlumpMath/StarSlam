...
::snow::api::buffers::ArrayBufferView Float64Array_Impl__obj::subarray( ::snow::api::buffers::ArrayBufferView this1,int begin,Dynamic end){
	HX_STACK_FRAME("snow.api.buffers._Float64Array.Float64Array_Impl_","subarray",0x014fe73e,"snow.api.buffers._Float64Array.Float64Array_Impl_.subarray","snow/api/buffers/Float64Array.hx",96,0xe97ae642)
...
::snow::api::buffers::ArrayBufferView Float64Array_Impl__obj::fromBytes( ::haxe::io::Bytes bytes,Dynamic __o_byteOffset,Dynamic len){
Dynamic byteOffset = __o_byteOffset.Default(0);
	HX_STACK_FRAME("snow.api.buffers._Float64Array.Float64Array_Impl_","fromBytes",0x0d131fdc,"snow.api.buffers._Float64Array.Float64Array_Impl_.fromBytes","snow/api/buffers/Float64Array.hx",100,0xe97ae642)
	...
	HX_STACK_ARG(len,"len")
{
		...
		HX_STACK_LINE(101)
		{
			...
			if ((tmp1)){
				HX_STACK_LINE(101)
				::snow::api::buffers::ArrayBufferView tmp2 = ::snow::api::buffers::ArrayBufferView_obj::__new(null(),(int)9);		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(101)
				this1 = tmp2;
			}
			else{
				...
				if ((tmp2)){
					...
					{
						HX_STACK_LINE(101)
						::snow::api::buffers::ArrayBufferView tmp4 = ::snow::api::buffers::ArrayBufferView_obj::__new((int)0,(int)9);		HX_STACK_VAR(tmp4,"tmp4");
						HX_STACK_LINE(101)
					...
					if ((tmp3)){
						...
						{
							HX_STACK_LINE(101)
							::snow::api::buffers::ArrayBufferView tmp5 = ::snow::api::buffers::ArrayBufferView_obj::__new((int)0,(int)9);		HX_STACK_VAR(tmp5,"tmp5");
							HX_STACK_LINE(101)
						...
						if ((tmp4)){
							...
							{
								HX_STACK_LINE(101)
								::snow::api::buffers::ArrayBufferView tmp6 = ::snow::api::buffers::ArrayBufferView_obj::__new((int)0,(int)9);		HX_STACK_VAR(tmp6,"tmp6");
								HX_STACK_LINE(101)
...
::haxe::io::Bytes Float64Array_Impl__obj::toBytes( ::snow::api::buffers::ArrayBufferView this1){
	HX_STACK_FRAME("snow.api.buffers._Float64Array.Float64Array_Impl_","toBytes",0xd94b2d6b,"snow.api.buffers._Float64Array.Float64Array_Impl_.toBytes","snow/api/buffers/Float64Array.hx",104,0xe97ae642)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(105)
...
int Float64Array_Impl__obj::get_length( ::snow::api::buffers::ArrayBufferView this1){
	HX_STACK_FRAME("snow.api.buffers._Float64Array.Float64Array_Impl_","get_length",0x88846b14,"snow.api.buffers._Float64Array.Float64Array_Impl_.get_length","snow/api/buffers/Float64Array.hx",110,0xe97ae642)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(110)
...
Float Float64Array_Impl__obj::__get( ::snow::api::buffers::ArrayBufferView this1,int idx){
	HX_STACK_FRAME("snow.api.buffers._Float64Array.Float64Array_Impl_","__get",0xa2991531,"snow.api.buffers._Float64Array.Float64Array_Impl_.__get","snow/api/buffers/Float64Array.hx",115,0xe97ae642)
	HX_STACK_ARG(this1,"this1")
...
Float Float64Array_Impl__obj::__set( ::snow::api::buffers::ArrayBufferView this1,int idx,Float val){
	HX_STACK_FRAME("snow.api.buffers._Float64Array.Float64Array_Impl_","__set",0xa2a2303d,"snow.api.buffers._Float64Array.Float64Array_Impl_.__set","snow/api/buffers/Float64Array.hx",121,0xe97ae642)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(idx,"idx")
...
::String Float64Array_Impl__obj::toString( ::snow::api::buffers::ArrayBufferView this1){
	HX_STACK_FRAME("snow.api.buffers._Float64Array.Float64Array_Impl_","toString",0x323d63d1,"snow.api.buffers._Float64Array.Float64Array_Impl_.toString","snow/api/buffers/Float64Array.hx",125,0xe97ae642)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(125)
	::String tmp = (HX_HCSTRING("Float64Array [byteLength:","\x32","\x73","\x38","\xac") + this1->byteLength);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(125)
