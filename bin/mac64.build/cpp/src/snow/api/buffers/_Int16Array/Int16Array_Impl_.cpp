...
::snow::api::buffers::ArrayBufferView Int16Array_Impl__obj::subarray( ::snow::api::buffers::ArrayBufferView this1,int begin,Dynamic end){
	HX_STACK_FRAME("snow.api.buffers._Int16Array.Int16Array_Impl_","subarray",0x3e08e0be,"snow.api.buffers._Int16Array.Int16Array_Impl_.subarray","snow/api/buffers/Int16Array.hx",96,0xe96fb73c)
...
::snow::api::buffers::ArrayBufferView Int16Array_Impl__obj::fromBytes( ::haxe::io::Bytes bytes,Dynamic __o_byteOffset,Dynamic len){
Dynamic byteOffset = __o_byteOffset.Default(0);
	HX_STACK_FRAME("snow.api.buffers._Int16Array.Int16Array_Impl_","fromBytes",0xf234765c,"snow.api.buffers._Int16Array.Int16Array_Impl_.fromBytes","snow/api/buffers/Int16Array.hx",100,0xe96fb73c)
	...
	HX_STACK_ARG(len,"len")
{
		...
		HX_STACK_LINE(101)
		{
			...
			if ((tmp1)){
				HX_STACK_LINE(101)
				::snow::api::buffers::ArrayBufferView tmp2 = ::snow::api::buffers::ArrayBufferView_obj::__new(null(),(int)2);		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(101)
				this1 = tmp2;
			}
			else{
				...
				if ((tmp2)){
					...
					{
						HX_STACK_LINE(101)
						::snow::api::buffers::ArrayBufferView tmp4 = ::snow::api::buffers::ArrayBufferView_obj::__new((int)0,(int)2);		HX_STACK_VAR(tmp4,"tmp4");
						HX_STACK_LINE(101)
					...
					if ((tmp3)){
						...
						{
							HX_STACK_LINE(101)
							::snow::api::buffers::ArrayBufferView tmp5 = ::snow::api::buffers::ArrayBufferView_obj::__new((int)0,(int)2);		HX_STACK_VAR(tmp5,"tmp5");
							HX_STACK_LINE(101)
						...
						if ((tmp4)){
							...
							{
								HX_STACK_LINE(101)
								::snow::api::buffers::ArrayBufferView tmp6 = ::snow::api::buffers::ArrayBufferView_obj::__new((int)0,(int)2);		HX_STACK_VAR(tmp6,"tmp6");
								HX_STACK_LINE(101)
...
::haxe::io::Bytes Int16Array_Impl__obj::toBytes( ::snow::api::buffers::ArrayBufferView this1){
	HX_STACK_FRAME("snow.api.buffers._Int16Array.Int16Array_Impl_","toBytes",0x1e71e3eb,"snow.api.buffers._Int16Array.Int16Array_Impl_.toBytes","snow/api/buffers/Int16Array.hx",104,0xe96fb73c)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(105)
...
int Int16Array_Impl__obj::get_length( ::snow::api::buffers::ArrayBufferView this1){
	HX_STACK_FRAME("snow.api.buffers._Int16Array.Int16Array_Impl_","get_length",0x208ec494,"snow.api.buffers._Int16Array.Int16Array_Impl_.get_length","snow/api/buffers/Int16Array.hx",110,0xe96fb73c)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(110)
...
int Int16Array_Impl__obj::__get( ::snow::api::buffers::ArrayBufferView this1,int idx){
	HX_STACK_FRAME("snow.api.buffers._Int16Array.Int16Array_Impl_","__get",0xe9ad2bb1,"snow.api.buffers._Int16Array.Int16Array_Impl_.__get","snow/api/buffers/Int16Array.hx",115,0xe96fb73c)
	HX_STACK_ARG(this1,"this1")
	...
	HX_STACK_LINE(116)
	int tmp4 = ::snow::api::buffers::ArrayBufferIO_obj::getInt16(tmp,tmp3,null());		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(116)
	return tmp4;
}
...
int Int16Array_Impl__obj::__set( ::snow::api::buffers::ArrayBufferView this1,int idx,int val){
	HX_STACK_FRAME("snow.api.buffers._Int16Array.Int16Array_Impl_","__set",0xe9b646bd,"snow.api.buffers._Int16Array.Int16Array_Impl_.__set","snow/api/buffers/Int16Array.hx",121,0xe96fb73c)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(idx,"idx")
	...
	HX_STACK_LINE(122)
	int tmp5 = ::snow::api::buffers::ArrayBufferIO_obj::setInt16(tmp,tmp3,tmp4,null());		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(122)
	return tmp5;
}
...
::String Int16Array_Impl__obj::toString( ::snow::api::buffers::ArrayBufferView this1){
	HX_STACK_FRAME("snow.api.buffers._Int16Array.Int16Array_Impl_","toString",0x6ef65d51,"snow.api.buffers._Int16Array.Int16Array_Impl_.toString","snow/api/buffers/Int16Array.hx",125,0xe96fb73c)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(125)
	::String tmp = (HX_HCSTRING("Int16Array [byteLength:","\x6c","\xaf","\x22","\x05") + this1->byteLength);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(125)
