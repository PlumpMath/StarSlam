...
::snow::api::buffers::ArrayBufferView Int32Array_Impl__obj::subarray( ::snow::api::buffers::ArrayBufferView this1,int begin,Dynamic end){
	HX_STACK_FRAME("snow.api.buffers._Int32Array.Int32Array_Impl_","subarray",0x7eecc6fe,"snow.api.buffers._Int32Array.Int32Array_Impl_.subarray","snow/api/buffers/Int32Array.hx",96,0x1e3f02f6)
...
::snow::api::buffers::ArrayBufferView Int32Array_Impl__obj::fromBytes( ::haxe::io::Bytes bytes,Dynamic __o_byteOffset,Dynamic len){
Dynamic byteOffset = __o_byteOffset.Default(0);
	HX_STACK_FRAME("snow.api.buffers._Int32Array.Int32Array_Impl_","fromBytes",0x78ba081c,"snow.api.buffers._Int32Array.Int32Array_Impl_.fromBytes","snow/api/buffers/Int32Array.hx",100,0x1e3f02f6)
	...
	HX_STACK_ARG(len,"len")
{
		...
		HX_STACK_LINE(101)
		{
			...
			if ((tmp1)){
				HX_STACK_LINE(101)
				::snow::api::buffers::ArrayBufferView tmp2 = ::snow::api::buffers::ArrayBufferView_obj::__new(null(),(int)3);		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(101)
				this1 = tmp2;
			}
			else{
				...
				if ((tmp2)){
					...
					{
						HX_STACK_LINE(101)
						::snow::api::buffers::ArrayBufferView tmp4 = ::snow::api::buffers::ArrayBufferView_obj::__new((int)0,(int)3);		HX_STACK_VAR(tmp4,"tmp4");
						HX_STACK_LINE(101)
					...
					if ((tmp3)){
						...
						{
							HX_STACK_LINE(101)
							::snow::api::buffers::ArrayBufferView tmp5 = ::snow::api::buffers::ArrayBufferView_obj::__new((int)0,(int)3);		HX_STACK_VAR(tmp5,"tmp5");
							HX_STACK_LINE(101)
						...
						if ((tmp4)){
							...
							{
								HX_STACK_LINE(101)
								::snow::api::buffers::ArrayBufferView tmp6 = ::snow::api::buffers::ArrayBufferView_obj::__new((int)0,(int)3);		HX_STACK_VAR(tmp6,"tmp6");
								HX_STACK_LINE(101)
...
::haxe::io::Bytes Int32Array_Impl__obj::toBytes( ::snow::api::buffers::ArrayBufferView this1){
	HX_STACK_FRAME("snow.api.buffers._Int32Array.Int32Array_Impl_","toBytes",0x75fb85ab,"snow.api.buffers._Int32Array.Int32Array_Impl_.toBytes","snow/api/buffers/Int32Array.hx",104,0x1e3f02f6)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(105)
...
int Int32Array_Impl__obj::get_length( ::snow::api::buffers::ArrayBufferView this1){
	HX_STACK_FRAME("snow.api.buffers._Int32Array.Int32Array_Impl_","get_length",0x4ee8bad4,"snow.api.buffers._Int32Array.Int32Array_Impl_.get_length","snow/api/buffers/Int32Array.hx",110,0x1e3f02f6)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(110)
...
int Int32Array_Impl__obj::__get( ::snow::api::buffers::ArrayBufferView this1,int idx){
	HX_STACK_FRAME("snow.api.buffers._Int32Array.Int32Array_Impl_","__get",0x0e16dd71,"snow.api.buffers._Int32Array.Int32Array_Impl_.__get","snow/api/buffers/Int32Array.hx",115,0x1e3f02f6)
	HX_STACK_ARG(this1,"this1")
...
int Int32Array_Impl__obj::__set( ::snow::api::buffers::ArrayBufferView this1,int idx,int val){
	HX_STACK_FRAME("snow.api.buffers._Int32Array.Int32Array_Impl_","__set",0x0e1ff87d,"snow.api.buffers._Int32Array.Int32Array_Impl_.__set","snow/api/buffers/Int32Array.hx",121,0x1e3f02f6)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(idx,"idx")
...
::String Int32Array_Impl__obj::toString( ::snow::api::buffers::ArrayBufferView this1){
	HX_STACK_FRAME("snow.api.buffers._Int32Array.Int32Array_Impl_","toString",0xafda4391,"snow.api.buffers._Int32Array.Int32Array_Impl_.toString","snow/api/buffers/Int32Array.hx",125,0x1e3f02f6)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(125)
	::String tmp = (HX_HCSTRING("Int32Array [byteLength:","\xa6","\xa7","\xb7","\xbd") + this1->byteLength);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(125)
