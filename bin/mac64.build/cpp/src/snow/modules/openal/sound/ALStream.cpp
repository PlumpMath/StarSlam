...
{
		HX_STACK_FRAME("snow.modules.openal.sound.ALStream","pause",0x1910a299,"snow.modules.openal.sound.ALStream.pause","snow/modules/openal/sound/ALStream.hx",230,0x0549770d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(232)
		this->super::pause();
		HX_STACK_LINE(233)
...
{
		HX_STACK_FRAME("snow.modules.openal.sound.ALStream","stop",0x2125a9bf,"snow.modules.openal.sound.ALStream.stop","snow/modules/openal/sound/ALStream.hx",237,0x0549770d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(239)
		this->super::stop();
		HX_STACK_LINE(241)
...
{
		HX_STACK_FRAME("snow.modules.openal.sound.ALStream","destroy",0x78c3675d,"snow.modules.openal.sound.ALStream.destroy","snow/modules/openal/sound/ALStream.hx",246,0x0549770d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(248)
		this->super::destroy();
		HX_STACK_LINE(250)
...
int ALStream_obj::get_position_bytes( ){
	HX_STACK_FRAME("snow.modules.openal.sound.ALStream","get_position_bytes",0x8c37a05b,"snow.modules.openal.sound.ALStream.get_position_bytes","snow/modules/openal/sound/ALStream.hx",260,0x0549770d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(262)
	::snow::modules::openal::sound::Sound tmp = this->owner;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(262)
...
Float ALStream_obj::get_position( ){
	HX_STACK_FRAME("snow.modules.openal.sound.ALStream","get_position",0xf6f9936f,"snow.modules.openal.sound.ALStream.get_position","snow/modules/openal/sound/ALStream.hx",266,0x0549770d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(269)
	int tmp = this->source;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(269)
...
int ALStream_obj::set_position_bytes( int _position_bytes){
	HX_STACK_FRAME("snow.modules.openal.sound.ALStream","set_position_bytes",0x68e6d2cf,"snow.modules.openal.sound.ALStream.set_position_bytes","snow/modules/openal/sound/ALStream.hx",275,0x0549770d)
	HX_STACK_THIS(this)
...
Float ALStream_obj::set_position( Float _position){
	HX_STACK_FRAME("snow.modules.openal.sound.ALStream","set_position",0x0bf2b6e3,"snow.modules.openal.sound.ALStream.set_position","snow/modules/openal/sound/ALStream.hx",283,0x0549770d)
	HX_STACK_THIS(this)
...
bool ALStream_obj::set_looping( bool _looping){
	HX_STACK_FRAME("snow.modules.openal.sound.ALStream","set_looping",0xa5f28c04,"snow.modules.openal.sound.ALStream.set_looping","snow/modules/openal/sound/ALStream.hx",310,0x0549770d)
	HX_STACK_THIS(this)
