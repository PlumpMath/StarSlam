...
HX_STACK_ARG(_options,"_options")
{
	...
	HX_STACK_LINE(34)
	{
		...
		if ((tmp)){
			HX_STACK_LINE(34)
			::luxe::DebugError tmp1 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("_options.id was null","\xb4","\x3b","\xea","\x09"));		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(34)
			HX_STACK_DO_THROW(tmp1);
		}
	}
	...
	HX_STACK_ARG(_force,"_force")
{
		...
		if ((tmp1)){
			HX_STACK_LINE(56)
			{
				...
				if ((tmp4)){
					HX_STACK_LINE(56)
					::luxe::DebugError tmp5 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("ref > 0","\x81","\x7a","\xcf","\xb6"));		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(56)
			...
			HX_STACK_LINE(58)
			{
				...
				if ((tmp4)){
					HX_STACK_LINE(58)
					::luxe::DebugError tmp5 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("ref >= 0","\xfc","\xa9","\xd1","\x3e"));		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(58)
					HX_STACK_DO_THROW(tmp5);
				}
			}
