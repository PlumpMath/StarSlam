...
Void SimpleActuator_obj::on_internal_update( Float dt){
{
		...
		Float tmp1 = tmp->timestamp();		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(457)
		::luxe::tween::actuators::SimpleActuator_obj::current_time = tmp1;
		HX_STACK_LINE(459)
		Float tmp2 = ::luxe::tween::actuators::SimpleActuator_obj::current_time;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(459)
		Float currentTime = tmp2;		HX_STACK_VAR(currentTime,"currentTime");
		HX_STACK_LINE(461)
		...
		HX_STACK_LINE(466)
		{
			...
			int _g1 = (int)0;		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(466)
			int tmp3 = ::luxe::tween::actuators::SimpleActuator_obj::actuatorsLength;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(466)
			...
			while((true)){
				...
				HX_STACK_LINE(468)
				::luxe::tween::actuators::SimpleActuator tmp7 = ::luxe::tween::actuators::SimpleActuator_obj::actuators->__get(j).StaticCast< ::luxe::tween::actuators::SimpleActuator >();		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(468)
				actuator = tmp7;
				HX_STACK_LINE(470)
				bool tmp8 = (actuator != null());		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(470)
				bool tmp9;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(470)
				if ((tmp8)){
					HX_STACK_LINE(470)
					tmp9 = actuator->active;
				}
				else{
					HX_STACK_LINE(470)
					tmp9 = false;
				...
				if ((tmp9)){
					HX_STACK_LINE(472)
					bool tmp10 = actuator->timescaled;		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(472)
					Float tmp11;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(472)
					if ((tmp10)){
						HX_STACK_LINE(472)
						tmp11 = ::luxe::tween::actuators::SimpleActuator_obj::update_timer;
					}
					else{
						HX_STACK_LINE(472)
						tmp11 = ::luxe::tween::actuators::SimpleActuator_obj::current_time;
					}
					HX_STACK_LINE(472)
					currentTime = tmp11;
					HX_STACK_LINE(474)
					...
					if ((tmp12)){
						HX_STACK_LINE(474)
						bool tmp14 = actuator->has_timescaled_starttime;		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(474)
						bool tmp15 = tmp14;		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(474)
						tmp13 = !(tmp15);
					...
					if ((tmp13)){
						...
						HX_STACK_LINE(476)
						Float tmp14 = ::luxe::tween::actuators::SimpleActuator_obj::update_timer;		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(476)
						actuator->startTime = tmp14;
						HX_STACK_LINE(477)
						actuator->timeOffset = actuator->startTime;
					}
					HX_STACK_LINE(480)
					bool tmp14 = (currentTime > actuator->timeOffset);		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(480)
					if ((tmp14)){
						HX_STACK_LINE(481)
						Float tmp15 = currentTime;		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(481)
						actuator->update(tmp15);
					}
					HX_STACK_LINE(484)
					(j)++;
				}
					...
					HX_STACK_LINE(488)
					::luxe::tween::actuators::SimpleActuator_obj::actuators->splice(tmp10,(int)1);
					HX_STACK_LINE(489)
					--(::luxe::tween::actuators::SimpleActuator_obj::actuatorsLength);
				}
			}
