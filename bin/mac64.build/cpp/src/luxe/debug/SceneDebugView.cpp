...
Void SceneDebugView_obj::add_scene( ::luxe::Scene _scene){
{
		...
		HX_STACK_LINE(52)
		{
			...
			if ((tmp3)){
				HX_STACK_LINE(52)
				::luxe::DebugError tmp4 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("scenes.indexOf(_scene) == -1","\x5a","\x3b","\x7b","\x64"));		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(52)
...
bool SceneDebugView_obj::remove_scene( ::luxe::Scene _scene){
	...
	HX_STACK_LINE(61)
	{
		...
		if ((tmp3)){
			HX_STACK_LINE(61)
			::luxe::DebugError tmp4 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("scenes.indexOf(_scene) != -1","\x3e","\xfd","\x42","\x45"));		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(61)
			HX_STACK_DO_THROW(tmp4);
		}
	}
...
Void SceneDebugView_obj::onmousewheel( Dynamic e){
{
		...
		HX_STACK_LINE(166)
		::phoenix::Vector tmp3 = tmp2->debug_inspector->size;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(166)
...
Void SceneDebugView_obj::resize( ){
{
		...
		::luxe::Debug debug = tmp;		HX_STACK_VAR(debug,"debug");
		HX_STACK_LINE(206)
		::phoenix::Vector tmp1 = debug->debug_inspector->pos;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(206)
		...
		HX_STACK_LINE(207)
		::phoenix::Vector tmp6 = debug->debug_inspector->pos;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(207)
		...
		HX_STACK_LINE(208)
		::phoenix::Vector tmp11 = debug->debug_inspector->size;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(208)
