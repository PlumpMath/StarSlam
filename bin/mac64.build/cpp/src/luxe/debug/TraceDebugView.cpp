...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(22)
	::String tmp4 = (tmp3 + HX_HCSTRING(" Debug Log","\xd7","\x33","\xf5","\xb8"));		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(22)
	this->add_line(tmp4);
}
;
...
Void TraceDebugView_obj::create( ){
{
		...
		HX_STACK_LINE(35)
		::luxe::Text tmp25 = ::luxe::Text_obj::__new(tmp24);		HX_STACK_VAR(tmp25,"tmp25");
		HX_STACK_LINE(35)
		this->lines = tmp25;
		HX_STACK_LINE(50)
		::luxe::Text tmp26 = this->lines;		HX_STACK_VAR(tmp26,"tmp26");
		HX_STACK_LINE(50)
		::phoenix::geometry::Geometry tmp27 = tmp26->geometry;		HX_STACK_VAR(tmp27,"tmp27");
		HX_STACK_LINE(50)
		bool tmp28 = (tmp27 != null());		HX_STACK_VAR(tmp28,"tmp28");
		HX_STACK_LINE(50)
		if ((tmp28)){
			HX_STACK_LINE(51)
			::luxe::Text tmp29 = this->lines;		HX_STACK_VAR(tmp29,"tmp29");
			HX_STACK_LINE(51)
			::phoenix::Rectangle tmp30 = text_bounds;		HX_STACK_VAR(tmp30,"tmp30");
			HX_STACK_LINE(51)
			tmp29->geometry->set_clip_rect(tmp30);
			HX_STACK_LINE(52)
			::luxe::Text tmp31 = this->lines;		HX_STACK_VAR(tmp31,"tmp31");
			HX_STACK_LINE(52)
			tmp31->geometry->set_locked(true);
			HX_STACK_LINE(53)
			::luxe::Text tmp32 = this->lines;		HX_STACK_VAR(tmp32,"tmp32");
			HX_STACK_LINE(53)
			tmp32->geometry->id = HX_HCSTRING("debug.log.text.geometry","\x4e","\x94","\x78","\x85");
		}
	}
return null();
}
