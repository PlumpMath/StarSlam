...
HX_STACK_ARG(compare_function,"compare_function")
{
	...
	HX_STACK_LINE(35)
	this->_array = cpp::ArrayBase_obj::__new();
}
;
	return null();
}
...
int BalancedBST_obj::size( ){
	HX_STACK_FRAME("luxe.structural.BalancedBST","size",0x2f83910d,"luxe.structural.BalancedBST.size","luxe/structural/BalancedBST.hx",42,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(44)
...
int BalancedBST_obj::depth( ){
	HX_STACK_FRAME("luxe.structural.BalancedBST","depth",0xbdec4337,"luxe.structural.BalancedBST.depth","luxe/structural/BalancedBST.hx",49,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(51)
	::luxe::structural::BalancedBSTNode tmp = this->root;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(51)
...
{
		HX_STACK_FRAME("luxe.structural.BalancedBST","insert",0xa122de85,"luxe.structural.BalancedBST.insert","luxe/structural/BalancedBST.hx",56,0xa0b365fc)
		HX_STACK_THIS(this)
...
bool BalancedBST_obj::contains( Dynamic _key){
	HX_STACK_FRAME("luxe.structural.BalancedBST","contains",0xc0d7606b,"luxe.structural.BalancedBST.contains","luxe/structural/BalancedBST.hx",67,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_key,"_key")
	HX_STACK_LINE(70)
...
Dynamic BalancedBST_obj::find( Dynamic _key){
	HX_STACK_FRAME("luxe.structural.BalancedBST","find",0x26ebc085,"luxe.structural.BalancedBST.find","luxe/structural/BalancedBST.hx",75,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_key,"_key")
	HX_STACK_LINE(77)
	::luxe::structural::BalancedBSTNode tmp = this->root;		HX_STACK_VAR(tmp,"tmp");
...
int BalancedBST_obj::rank( Dynamic _key){
	HX_STACK_FRAME("luxe.structural.BalancedBST","rank",0x2ed43df8,"luxe.structural.BalancedBST.rank","luxe/structural/BalancedBST.hx",83,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_key,"_key")
	HX_STACK_LINE(85)
	Dynamic tmp = _key;		HX_STACK_VAR(tmp,"tmp");
...
Dynamic BalancedBST_obj::select( int _rank){
	HX_STACK_FRAME("luxe.structural.BalancedBST","select",0x6d78b648,"luxe.structural.BalancedBST.select","luxe/structural/BalancedBST.hx",91,0xa0b365fc)
	HX_STACK_THIS(this)
...
Dynamic BalancedBST_obj::smallest( ){
	HX_STACK_FRAME("luxe.structural.BalancedBST","smallest",0x3a3d942b,"luxe.structural.BalancedBST.smallest","luxe/structural/BalancedBST.hx",104,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(106)
	::luxe::structural::BalancedBSTNode tmp = this->root;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(106)
...
Dynamic BalancedBST_obj::largest( ){
	HX_STACK_FRAME("luxe.structural.BalancedBST","largest",0x155e8450,"luxe.structural.BalancedBST.largest","luxe/structural/BalancedBST.hx",117,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(119)
	::luxe::structural::BalancedBSTNode tmp = this->root;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(119)
...
bool BalancedBST_obj::remove( Dynamic _key){
	HX_STACK_FRAME("luxe.structural.BalancedBST","remove",0x07ce3790,"luxe.structural.BalancedBST.remove","luxe/structural/BalancedBST.hx",130,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_key,"_key")
	HX_STACK_LINE(132)
...
bool BalancedBST_obj::remove_smallest( ){
	HX_STACK_FRAME("luxe.structural.BalancedBST","remove_smallest",0xa58ddbae,"luxe.structural.BalancedBST.remove_smallest","luxe/structural/BalancedBST.hx",154,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(156)
	bool tmp;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(156)
...
bool BalancedBST_obj::remove_largest( ){
	HX_STACK_FRAME("luxe.structural.BalancedBST","remove_largest",0x809cde2d,"luxe.structural.BalancedBST.remove_largest","luxe/structural/BalancedBST.hx",174,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(177)
	bool tmp;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(177)
...
Dynamic BalancedBST_obj::floor( Dynamic _key){
	HX_STACK_FRAME("luxe.structural.BalancedBST","floor",0xe9592400,"luxe.structural.BalancedBST.floor","luxe/structural/BalancedBST.hx",195,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_key,"_key")
	HX_STACK_LINE(197)
	::luxe::structural::BalancedBSTNode tmp = this->root;		HX_STACK_VAR(tmp,"tmp");
...
Dynamic BalancedBST_obj::ceil( Dynamic _key){
	HX_STACK_FRAME("luxe.structural.BalancedBST","ceil",0x24ed0f51,"luxe.structural.BalancedBST.ceil","luxe/structural/BalancedBST.hx",208,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_key,"_key")
	HX_STACK_LINE(210)
	::luxe::structural::BalancedBSTNode tmp = this->root;		HX_STACK_VAR(tmp,"tmp");
...
cpp::ArrayBase BalancedBST_obj::toArray( ){
	HX_STACK_FRAME("luxe.structural.BalancedBST","toArray",0xcbb60152,"luxe.structural.BalancedBST.toArray","luxe/structural/BalancedBST.hx",221,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(223)
...
cpp::ArrayBase BalancedBST_obj::keys( ){
	HX_STACK_FRAME("luxe.structural.BalancedBST","keys",0x2a36d240,"luxe.structural.BalancedBST.keys","luxe/structural/BalancedBST.hx",234,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(236)
	cpp::ArrayBase a = Dynamic( Array_obj<Dynamic>::__new() );		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(238)
...
Dynamic BalancedBST_obj::iterator( ){
	HX_STACK_FRAME("luxe.structural.BalancedBST","iterator",0x27f6503a,"luxe.structural.BalancedBST.iterator","luxe/structural/BalancedBST.hx",248,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(250)
	Dynamic tmp = this->_array->__Field(HX_HCSTRING("iterator","\xee","\x49","\x9a","\x93"), hx::paccDynamic )();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(250)
	return tmp;
}
...
{
		HX_STACK_FRAME("luxe.structural.BalancedBST","traverse_node",0xbc7f6923,"luxe.structural.BalancedBST.traverse_node","luxe/structural/BalancedBST.hx",256,0xa0b365fc)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_node,"_node")
...
bool BalancedBST_obj::get_empty( ){
	HX_STACK_FRAME("luxe.structural.BalancedBST","get_empty",0xefad1318,"luxe.structural.BalancedBST.get_empty","luxe/structural/BalancedBST.hx",286,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(288)
	::luxe::structural::BalancedBSTNode tmp = this->root;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(288)
...
int BalancedBST_obj::node_depth( ::luxe::structural::BalancedBSTNode _node){
	HX_STACK_FRAME("luxe.structural.BalancedBST","node_depth",0x118ce112,"luxe.structural.BalancedBST.node_depth","luxe/structural/BalancedBST.hx",293,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_LINE(295)
	bool tmp = (_node == null());		HX_STACK_VAR(tmp,"tmp");
...
int BalancedBST_obj::node_count( ::luxe::structural::BalancedBSTNode _node){
	HX_STACK_FRAME("luxe.structural.BalancedBST","node_count",0x84c634de,"luxe.structural.BalancedBST.node_count","luxe/structural/BalancedBST.hx",309,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_LINE(311)
	bool tmp = (_node == null());		HX_STACK_VAR(tmp,"tmp");
...
::luxe::structural::BalancedBSTNode BalancedBST_obj::node_insert( ::luxe::structural::BalancedBSTNode _node,Dynamic _key,Dynamic _value){
	HX_STACK_FRAME("luxe.structural.BalancedBST","node_insert",0x7a0c604a,"luxe.structural.BalancedBST.node_insert","luxe/structural/BalancedBST.hx",316,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_ARG(_key,"_key")
	HX_STACK_ARG(_value,"_value")
	...
	HX_STACK_LINE(355)
	::luxe::structural::BalancedBSTNode tmp12 = _node;		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(355)
	return tmp12;
}
...
::luxe::structural::BalancedBSTNode BalancedBST_obj::node_update_count( ::luxe::structural::BalancedBSTNode _node){
	HX_STACK_FRAME("luxe.structural.BalancedBST","node_update_count",0x6c497eaa,"luxe.structural.BalancedBST.node_update_count","luxe/structural/BalancedBST.hx",360,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_LINE(362)
	::luxe::structural::BalancedBSTNode tmp = _node->left;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(362)
	int tmp1 = this->node_count(tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(362)
	...
	HX_STACK_LINE(364)
	::luxe::structural::BalancedBSTNode tmp6 = _node;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(364)
	return tmp6;
}
...
Dynamic BalancedBST_obj::node_find( ::luxe::structural::BalancedBSTNode _node,Dynamic _key){
	HX_STACK_FRAME("luxe.structural.BalancedBST","node_find",0x43fed70a,"luxe.structural.BalancedBST.node_find","luxe/structural/BalancedBST.hx",369,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_ARG(_key,"_key")
	HX_STACK_LINE(371)
...
int BalancedBST_obj::node_rank( Dynamic _key,::luxe::structural::BalancedBSTNode _node){
	HX_STACK_FRAME("luxe.structural.BalancedBST","node_rank",0x4be7547d,"luxe.structural.BalancedBST.node_rank","luxe/structural/BalancedBST.hx",388,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_key,"_key")
	HX_STACK_ARG(_node,"_node")
	HX_STACK_LINE(390)
	...
	if ((tmp4)){
		...
		if ((tmp5)){
			...
			HX_STACK_LINE(399)
			::luxe::structural::BalancedBSTNode tmp10 = _node->right;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(399)
...
::luxe::structural::BalancedBSTNode BalancedBST_obj::node_select( ::luxe::structural::BalancedBSTNode _node,int _rank){
	HX_STACK_FRAME("luxe.structural.BalancedBST","node_select",0x4662380d,"luxe.structural.BalancedBST.node_select","luxe/structural/BalancedBST.hx",407,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_ARG(_rank,"_rank")
	HX_STACK_LINE(409)
	...
	if ((tmp3)){
		HX_STACK_LINE(416)
		::luxe::structural::BalancedBSTNode tmp4 = _node->left;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(416)
		int tmp5 = _rank;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(416)
		::luxe::structural::BalancedBSTNode tmp6 = this->node_select(tmp4,tmp5);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(416)
		return tmp6;
	}
	else{
		...
		if ((tmp4)){
			...
			HX_STACK_LINE(418)
			::luxe::structural::BalancedBSTNode tmp8 = this->node_select(tmp5,tmp7);		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(418)
			return tmp8;
		}
		else{
...
::luxe::structural::BalancedBSTNode BalancedBST_obj::node_smallest( ::luxe::structural::BalancedBSTNode _node){
	HX_STACK_FRAME("luxe.structural.BalancedBST","node_smallest",0x41ded130,"luxe.structural.BalancedBST.node_smallest","luxe/structural/BalancedBST.hx",426,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_LINE(428)
...
::luxe::structural::BalancedBSTNode BalancedBST_obj::node_largest( ::luxe::structural::BalancedBSTNode _node){
	HX_STACK_FRAME("luxe.structural.BalancedBST","node_largest",0x08c68eeb,"luxe.structural.BalancedBST.node_largest","luxe/structural/BalancedBST.hx",437,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_LINE(439)
...
::luxe::structural::BalancedBSTNode BalancedBST_obj::node_floor( ::luxe::structural::BalancedBSTNode _node,Dynamic _key){
	HX_STACK_FRAME("luxe.structural.BalancedBST","node_floor",0x3cf9c1db,"luxe.structural.BalancedBST.node_floor","luxe/structural/BalancedBST.hx",448,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_ARG(_key,"_key")
	HX_STACK_LINE(450)
...
::luxe::structural::BalancedBSTNode BalancedBST_obj::node_ceil( ::luxe::structural::BalancedBSTNode _node,Dynamic _key){
	HX_STACK_FRAME("luxe.structural.BalancedBST","node_ceil",0x420025d6,"luxe.structural.BalancedBST.node_ceil","luxe/structural/BalancedBST.hx",473,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_ARG(_key,"_key")
	HX_STACK_LINE(475)
...
::luxe::structural::BalancedBSTNode BalancedBST_obj::node_remove_smallest( ::luxe::structural::BalancedBSTNode _node){
	HX_STACK_FRAME("luxe.structural.BalancedBST","node_remove_smallest",0x673a7949,"luxe.structural.BalancedBST.node_remove_smallest","luxe/structural/BalancedBST.hx",502,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_LINE(504)
	bool tmp = (_node->left == null());		HX_STACK_VAR(tmp,"tmp");
	...
	if ((tmp4)){
		...
		::luxe::structural::BalancedBSTNode tmp5 = _node;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(509)
		::luxe::structural::BalancedBSTNode tmp6 = this->move_red_left(tmp5);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(509)
		_node = tmp6;
	}
	HX_STACK_LINE(512)
	...
	HX_STACK_LINE(515)
	::luxe::structural::BalancedBSTNode tmp8 = _node;		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(515)
	::luxe::structural::BalancedBSTNode tmp9 = this->balance(tmp8);		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(515)
	return tmp9;
}
...
::luxe::structural::BalancedBSTNode BalancedBST_obj::node_remove_largest( ::luxe::structural::BalancedBSTNode _node){
	HX_STACK_FRAME("luxe.structural.BalancedBST","node_remove_largest",0xe4352cf2,"luxe.structural.BalancedBST.node_remove_largest","luxe/structural/BalancedBST.hx",520,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_LINE(522)
	bool tmp;		HX_STACK_VAR(tmp,"tmp");
	...
	if ((tmp5)){
		...
		::luxe::structural::BalancedBSTNode tmp6 = _node;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(531)
		::luxe::structural::BalancedBSTNode tmp7 = this->move_red_right(tmp6);		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(531)
		_node = tmp7;
	}
	HX_STACK_LINE(534)
	...
	::luxe::structural::BalancedBSTNode tmp9 = _node;		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(537)
	::luxe::structural::BalancedBSTNode tmp10 = this->balance(tmp9);		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(537)
	return tmp10;
}
...
::luxe::structural::BalancedBSTNode BalancedBST_obj::node_remove( ::luxe::structural::BalancedBSTNode _node,Dynamic _key){
	HX_STACK_FRAME("luxe.structural.BalancedBST","node_remove",0xe0b7b955,"luxe.structural.BalancedBST.node_remove","luxe/structural/BalancedBST.hx",542,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_ARG(_key,"_key")
	HX_STACK_LINE(544)
	...
	if ((tmp3)){
		...
		if ((tmp7)){
			...
			::luxe::structural::BalancedBSTNode tmp8 = _node;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(549)
			::luxe::structural::BalancedBSTNode tmp9 = this->move_red_left(tmp8);		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(549)
			_node = tmp9;
		}
		HX_STACK_LINE(552)
		...
		if ((tmp13)){
			HX_STACK_LINE(567)
			::luxe::structural::BalancedBSTNode tmp14 = _node;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(567)
			::luxe::structural::BalancedBSTNode tmp15 = this->move_red_right(tmp14);		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(567)
			_node = tmp15;
		}
		HX_STACK_LINE(570)
	...
	::luxe::structural::BalancedBSTNode tmp4 = _node;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(585)
	::luxe::structural::BalancedBSTNode tmp5 = this->balance(tmp4);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(585)
	return tmp5;
}
...
bool BalancedBST_obj::is_red( ::luxe::structural::BalancedBSTNode _node){
	HX_STACK_FRAME("luxe.structural.BalancedBST","is_red",0x74f55288,"luxe.structural.BalancedBST.is_red","luxe/structural/BalancedBST.hx",589,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_LINE(591)
	bool tmp = (_node == null());		HX_STACK_VAR(tmp,"tmp");
...
::luxe::structural::BalancedBSTNode BalancedBST_obj::rotate_left( ::luxe::structural::BalancedBSTNode _node){
	HX_STACK_FRAME("luxe.structural.BalancedBST","rotate_left",0xf004e4df,"luxe.structural.BalancedBST.rotate_left","luxe/structural/BalancedBST.hx",599,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_LINE(601)
	...
	HX_STACK_LINE(614)
	::luxe::structural::BalancedBSTNode tmp1 = _n;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(614)
	return tmp1;
}
...
::luxe::structural::BalancedBSTNode BalancedBST_obj::rotate_right( ::luxe::structural::BalancedBSTNode _node){
	HX_STACK_FRAME("luxe.structural.BalancedBST","rotate_right",0x8b506c04,"luxe.structural.BalancedBST.rotate_right","luxe/structural/BalancedBST.hx",618,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_LINE(620)
...
{
		HX_STACK_FRAME("luxe.structural.BalancedBST","swap_color",0xfb93c4c3,"luxe.structural.BalancedBST.swap_color","luxe/structural/BalancedBST.hx",637,0xa0b365fc)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_node,"_node")
		HX_STACK_LINE(639)
...
::luxe::structural::BalancedBSTNode BalancedBST_obj::move_red_left( ::luxe::structural::BalancedBSTNode _node){
	HX_STACK_FRAME("luxe.structural.BalancedBST","move_red_left",0x3cc03557,"luxe.structural.BalancedBST.move_red_left","luxe/structural/BalancedBST.hx",645,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_LINE(647)
	::luxe::structural::BalancedBSTNode tmp = _node;		HX_STACK_VAR(tmp,"tmp");
...
::luxe::structural::BalancedBSTNode BalancedBST_obj::move_red_right( ::luxe::structural::BalancedBSTNode _node){
	HX_STACK_FRAME("luxe.structural.BalancedBST","move_red_right",0x627b848c,"luxe.structural.BalancedBST.move_red_right","luxe/structural/BalancedBST.hx",657,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_LINE(659)
	::luxe::structural::BalancedBSTNode tmp = _node;		HX_STACK_VAR(tmp,"tmp");
...
::luxe::structural::BalancedBSTNode BalancedBST_obj::balance( ::luxe::structural::BalancedBSTNode _node){
	HX_STACK_FRAME("luxe.structural.BalancedBST","balance",0xfd2fe450,"luxe.structural.BalancedBST.balance","luxe/structural/BalancedBST.hx",668,0xa0b365fc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_node,"_node")
	HX_STACK_LINE(670)
	bool tmp;		HX_STACK_VAR(tmp,"tmp");
...
Dynamic BalancedBST_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"_array") ) { _array=inValue.Cast< cpp::ArrayBase >(); return inValue; }
		break;
	case 7:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(BalancedBST_obj,_array),HX_HCSTRING("_array","\xda","\xb4","\x76","\x21")},
	{ hx::fsUnknown, 0, null()}
};
