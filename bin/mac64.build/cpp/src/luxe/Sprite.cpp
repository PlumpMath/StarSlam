...
HX_STACK_ARG(options,"options")
{
	...
	HX_STACK_LINE(29)
	{
		...
		if ((tmp1)){
			HX_STACK_LINE(29)
			::luxe::DebugError tmp2 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("options was null (Sprite requires non-null options)","\x45","\x79","\x47","\x18"));		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(29)
...
::phoenix::Rectangle Sprite_obj::set_uv( ::phoenix::Rectangle _uv){
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(131)
		::phoenix::Rectangle tmp3 = _uv;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(131)
		tmp2->uv(tmp3);
	}
	HX_STACK_LINE(134)
...
::phoenix::Vector Sprite_obj::set_size( ::phoenix::Vector _v){
	...
	if ((tmp1)){
		...
		::phoenix::geometry::QuadGeometry tmp2 = this->geometry_quad;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(179)
		::phoenix::Vector tmp3 = ::phoenix::Vector_obj::__new(_v->x,_v->y,null(),null());		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(179)
		tmp2->resize(tmp3);
		HX_STACK_LINE(182)
		bool tmp4 = this->_has_custom_origin;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(182)
		bool tmp5 = !(tmp4);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(182)
		if ((tmp5)){
			HX_STACK_LINE(183)
			bool tmp6 = this->centered;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(183)
			if ((tmp6)){
				HX_STACK_LINE(185)
				...
				{
					HX_STACK_LINE(185)
					::phoenix::Vector tmp8 = ::phoenix::Vector_obj::__new(_v->x,_v->y,_v->z,_v->w);		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(185)
					...
					if ((tmp9)){
						HX_STACK_LINE(185)
						Float tmp10 = (Float(_this->x) / Float((int)2));		HX_STACK_VAR(tmp10,"tmp10");
						HX_STACK_LINE(185)
						Float _x = tmp10;		HX_STACK_VAR(_x,"_x");
						HX_STACK_LINE(185)
						Float tmp11 = (Float(_this->y) / Float((int)2));		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(185)
						Float _y = tmp11;		HX_STACK_VAR(_y,"_y");
						HX_STACK_LINE(185)
						Float tmp12 = (Float(_this->z) / Float((int)2));		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(185)
						...
						if ((tmp15)){
							HX_STACK_LINE(185)
							Float tmp16 = _this->z;		HX_STACK_VAR(tmp16,"tmp16");
							HX_STACK_LINE(185)
							_this->listen_z(tmp16);
						}
						HX_STACK_LINE(185)
