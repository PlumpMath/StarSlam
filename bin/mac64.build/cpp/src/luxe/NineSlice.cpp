...
{
		HX_STACK_FRAME("luxe.NineSlice","lock",0x52230331,"luxe.NineSlice.lock","luxe/NineSlice.hx",101,0xccc9c257)
		HX_STACK_THIS(this)
		HX_STACK_LINE(102)
...
{
		HX_STACK_FRAME("luxe.NineSlice","dirty",0xed5f460c,"luxe.NineSlice.dirty","luxe/NineSlice.hx",107,0xccc9c257)
		HX_STACK_THIS(this)
		HX_STACK_LINE(108)
		bool tmp = this->is_set;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(108)
...
{
		HX_STACK_FRAME("luxe.NineSlice","update_size",0x2a7a6371,"luxe.NineSlice.update_size","luxe/NineSlice.hx",113,0xccc9c257)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("luxe.NineSlice","set",0xa11b3f1c,"luxe.NineSlice.set","luxe/NineSlice.hx",206,0xccc9c257)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_width,"_width")
		HX_STACK_ARG(_height,"_height")
		HX_STACK_LINE(208)
		...
		struct _Function_1_1{
			inline static Dynamic Block( Float &tmp17,Float &tmp20,Float &tmp19,Float &tmp15,Float &tmp16,::phoenix::Vector &tmp18,Float &tmp14){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",222,0xccc9c257)
				{
					hx::Anon __result = hx::Anon_obj::Create();
		...
		struct _Function_1_2{
			inline static Dynamic Block( ::phoenix::Vector &tmp33,Float &tmp38,Float &tmp26,Float &tmp31,Float &tmp27,Float &tmp39,Float &tmp30){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",233,0xccc9c257)
				{
					hx::Anon __result = hx::Anon_obj::Create();
		...
		struct _Function_1_3{
			inline static Dynamic Block( Float &tmp48,Float &tmp54,Float &tmp42,::phoenix::Vector &tmp52,Float &tmp47,Float &tmp41,Float &tmp53){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",244,0xccc9c257)
				{
					hx::Anon __result = hx::Anon_obj::Create();
		...
		struct _Function_1_4{
			inline static Dynamic Block( Float &tmp73,Float &tmp68,Float &tmp62,Float &tmp56,Float &tmp61,::phoenix::Vector &tmp67,Float &tmp65){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",257,0xccc9c257)
				{
					hx::Anon __result = hx::Anon_obj::Create();
		...
		struct _Function_1_5{
			inline static Dynamic Block( Float &tmp98,Float &tmp103,Float &tmp90,Float &tmp79,Float &tmp84,Float &tmp87,::phoenix::Vector &tmp93){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",268,0xccc9c257)
				{
					hx::Anon __result = hx::Anon_obj::Create();
		...
		struct _Function_1_6{
			inline static Dynamic Block( Float &tmp110,Float &tmp118,Float &tmp124,Float &tmp115,::phoenix::Vector &tmp123,Float &tmp129,Float &tmp105){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",279,0xccc9c257)
				{
					hx::Anon __result = hx::Anon_obj::Create();
		...
		struct _Function_1_7{
			inline static Dynamic Block( ::phoenix::Vector &tmp142,Float &tmp144,Float &tmp138,Float &tmp132,Float &tmp143,Float &tmp131,Float &tmp133){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",292,0xccc9c257)
				{
					hx::Anon __result = hx::Anon_obj::Create();
		...
		struct _Function_1_8{
			inline static Dynamic Block( ::phoenix::Vector &tmp164,Float &tmp151,Float &tmp150,Float &tmp159,Float &tmp169,Float &tmp154,Float &tmp170){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",303,0xccc9c257)
				{
					hx::Anon __result = hx::Anon_obj::Create();
		...
		struct _Function_1_9{
			inline static Dynamic Block( Float &tmp192,Float &tmp178,Float &tmp173,::phoenix::Vector &tmp190,Float &tmp172,Float &tmp183,Float &tmp191){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",314,0xccc9c257)
				{
					hx::Anon __result = hx::Anon_obj::Create();
...
::phoenix::Vector NineSlice_obj::set_size( ::phoenix::Vector _v){
	HX_STACK_FRAME("luxe.NineSlice","set_size",0x2a233804,"luxe.NineSlice.set_size","luxe/NineSlice.hx",329,0xccc9c257)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_v,"_v")
	HX_STACK_LINE(331)
	bool tmp = this->is_set;		HX_STACK_VAR(tmp,"tmp");
...
Dynamic _reset = __o__reset.Default(false);
	HX_STACK_FRAME("luxe.NineSlice","_create",0x383a6115,"luxe.NineSlice._create","luxe/NineSlice.hx",345,0xccc9c257)
	HX_STACK_THIS(this)
	...
	HX_STACK_ARG(_reset,"_reset")
{
		...
		HX_STACK_LINE(357)
		Dynamic tmp11 = tmp10->__Field(HX_HCSTRING("group","\x3f","\xb3","\xf4","\x99"), hx::paccDynamic );		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(358)
		Dynamic tmp12 = this->nineslice_options;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(358)
		Dynamic tmp13 = tmp12->__Field(HX_HCSTRING("visible","\x72","\x78","\x24","\xa3"), hx::paccDynamic );		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(359)
		::phoenix::Batcher tmp14 = this->_batcher;		HX_STACK_VAR(tmp14,"tmp14");
		struct _Function_1_1{
			inline static Dynamic Block( ::phoenix::Texture &tmp6,Dynamic &tmp13,Dynamic &tmp9,Dynamic &tmp11,::phoenix::Color &tmp7,::phoenix::Batcher &tmp14){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",353,0xccc9c257)
				{
					hx::Anon __result = hx::Anon_obj::Create();
					...
					__result->Add(HX_HCSTRING("group","\x3f","\xb3","\xf4","\x99") , tmp11,false);
					__result->Add(HX_HCSTRING("visible","\x72","\x78","\x24","\xa3") , tmp13,false);
		...
		HX_STACK_LINE(353)
		Dynamic tmp15 = _Function_1_1::Block(tmp6,tmp13,tmp9,tmp11,tmp7,tmp14);		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(353)
		::phoenix::geometry::QuadPackGeometry tmp16 = ::phoenix::geometry::QuadPackGeometry_obj::__new(tmp15);		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(353)
		this->_geometry = tmp16;
		HX_STACK_LINE(362)
		{
			HX_STACK_LINE(362)
			int _g = (int)0;		HX_STACK_VAR(_g,"_g");
			...
			while((true)){
				...
				HX_STACK_LINE(362)
				Dynamic slice = tmp19;		HX_STACK_VAR(slice,"slice");
				HX_STACK_LINE(362)
				++(_g);
				HX_STACK_LINE(364)
				::phoenix::geometry::QuadPackGeometry tmp20 = this->_geometry;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(365)
				Float tmp21 = slice->__Field(HX_HCSTRING("pos","\x94","\x5d","\x55","\x00"), hx::paccDynamic )->__Field(HX_HCSTRING("x","\x78","\x00","\x00","\x00"), hx::paccDynamic );		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(366)
				Float tmp22 = slice->__Field(HX_HCSTRING("pos","\x94","\x5d","\x55","\x00"), hx::paccDynamic )->__Field(HX_HCSTRING("y","\x79","\x00","\x00","\x00"), hx::paccDynamic );		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(367)
				Float tmp23 = slice->__Field(HX_HCSTRING("width","\x06","\xb6","\x62","\xca"), hx::paccDynamic );		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(368)
				Float tmp24 = slice->__Field(HX_HCSTRING("height","\xe7","\x07","\x4c","\x02"), hx::paccDynamic );		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(369)
				Dynamic tmp25 = this->nineslice_options;		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(369)
				::phoenix::Color tmp26 = tmp25->__Field(HX_HCSTRING("color","\x63","\x71","\x5c","\x4a"), hx::paccDynamic );		HX_STACK_VAR(tmp26,"tmp26");
				HX_STACK_LINE(370)
				::phoenix::Rectangle tmp27 = ::phoenix::Rectangle_obj::__new(slice->__Field(HX_HCSTRING("source_x","\xd4","\x30","\xa4","\x66"), hx::paccDynamic ),slice->__Field(HX_HCSTRING("source_y","\xd5","\x30","\xa4","\x66"), hx::paccDynamic ),slice->__Field(HX_HCSTRING("source_width","\x62","\x44","\xbc","\x87"), hx::paccDynamic ),slice->__Field(HX_HCSTRING("source_height","\x0b","\x0a","\x4f","\xf3"), hx::paccDynamic ));		HX_STACK_VAR(tmp27,"tmp27");
				struct _Function_3_1{
					inline static Dynamic Block( Float &tmp22,Float &tmp23,::phoenix::Color &tmp26,Float &tmp21,Float &tmp24,::phoenix::Rectangle &tmp27){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",364,0xccc9c257)
						{
							hx::Anon __result = hx::Anon_obj::Create();
							__result->Add(HX_HCSTRING("x","\x78","\x00","\x00","\x00") , tmp21,false);
							__result->Add(HX_HCSTRING("y","\x79","\x00","\x00","\x00") , tmp22,false);
							__result->Add(HX_HCSTRING("w","\x77","\x00","\x00","\x00") , tmp23,false);
							__result->Add(HX_HCSTRING("h","\x68","\x00","\x00","\x00") , tmp24,false);
							__result->Add(HX_HCSTRING("color","\x63","\x71","\x5c","\x4a") , tmp26,false);
							__result->Add(HX_HCSTRING("uv","\x61","\x66","\x00","\x00") , tmp27,false);
							return __result;
						}
						return null();
					}
				...
				HX_STACK_LINE(364)
				Dynamic tmp28 = _Function_3_1::Block(tmp22,tmp23,tmp26,tmp21,tmp24,tmp27);		HX_STACK_VAR(tmp28,"tmp28");
				HX_STACK_LINE(364)
				int tmp29 = tmp20->quad_add(tmp28);		HX_STACK_VAR(tmp29,"tmp29");
				HX_STACK_LINE(364)
				slice->__FieldRef(HX_HCSTRING("geometry_id","\x88","\xaa","\x54","\x45")) = tmp29;
			}
		}
		HX_STACK_LINE(377)
		...
		HX_STACK_LINE(377)
		::String tmp19 = (HX_HCSTRING("NineSlice","\xa0","\x79","\x78","\x0d") + tmp18);		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(377)
		::phoenix::geometry::QuadPackGeometry tmp20 = this->_geometry;		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(377)
		tmp20->id = tmp19;
...
Dynamic _reset = __o__reset.Default(false);
	HX_STACK_FRAME("luxe.NineSlice","create",0x8597abc2,"luxe.NineSlice.create","luxe/NineSlice.hx",386,0xccc9c257)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_pos,"_pos")
	HX_STACK_ARG(_w,"_w")
	HX_STACK_ARG(_h,"_h")
