...
Void Resources_obj::track( ::luxe::Parcel _cache){
{
		...
		HX_STACK_LINE(41)
		{
			...
			if ((tmp)){
				HX_STACK_LINE(41)
				::luxe::DebugError tmp1 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("_cache was null","\x1b","\x2f","\x49","\x0c"));		HX_STACK_VAR(tmp1,"tmp1");
				HX_STACK_LINE(41)
		...
		HX_STACK_LINE(42)
		{
			...
			if ((tmp3)){
				HX_STACK_LINE(42)
				::luxe::DebugError tmp4 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("parcels.indexOf(_cache) == -1","\x47","\xd5","\x0c","\x9e"));		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(42)
...
Void Resources_obj::add( ::luxe::resource::Resource resource){
{
		...
		HX_STACK_LINE(66)
		{
			...
			if ((tmp4)){
				HX_STACK_LINE(66)
				::luxe::DebugError tmp5 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("!cache.exists(resource.id)","\xad","\x72","\xb7","\xbe"));		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(66)
...
bool Resources_obj::remove( ::luxe::resource::Resource resource){
	...
	HX_STACK_LINE(79)
	{
		...
		if ((tmp3)){
			HX_STACK_LINE(79)
			::luxe::DebugError tmp4 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("cache.exists(resource.id)","\xee","\x50","\xde","\x37"));		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(79)
			HX_STACK_DO_THROW(tmp4);
		}
	}
...
::snow::api::Promise Resources_obj::load_bytes( ::String _id){
	...
	HX_STACK_LINE(141)
	{
		...
		if ((tmp)){
			HX_STACK_LINE(141)
			::luxe::DebugError tmp1 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("_id was null","\xc4","\x57","\x88","\xc5"));		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(141)
			HX_STACK_DO_THROW(tmp1);
		}
	}
