...
int _slot = __o__slot.Default(0);
	HX_STACK_FRAME("luxe.IO","string_save",0x981f31db,"luxe.IO.string_save","luxe/IO.hx",36,0xc6be543f)
	HX_STACK_THIS(this)
...
int _slot = __o__slot.Default(0);
	HX_STACK_FRAME("luxe.IO","string_load",0x938940c4,"luxe.IO.string_load","luxe/IO.hx",45,0xc6be543f)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_key,"_key")
	HX_STACK_ARG(_slot,"_slot")
{
...
::String IO_obj::get_app_path( ){
	HX_STACK_FRAME("luxe.IO","get_app_path",0x04eb121c,"luxe.IO.get_app_path","luxe/IO.hx",55,0xc6be543f)
	HX_STACK_THIS(this)
	HX_STACK_LINE(57)
	::luxe::Core tmp = this->core;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(57)
...
::String IO_obj::get_app_path_prefs( ){
	HX_STACK_FRAME("luxe.IO","get_app_path_prefs",0xda4d1e8d,"luxe.IO.get_app_path_prefs","luxe/IO.hx",61,0xc6be543f)
	HX_STACK_THIS(this)
	HX_STACK_LINE(63)
	::luxe::Core tmp = this->core;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(63)
...
Void IO_obj::init( ){
{
		HX_STACK_FRAME("luxe.IO","init",0x799aabe0,"luxe.IO.init","luxe/IO.hx",69,0xc6be543f)
		HX_STACK_THIS(this)
	}
return null();
}
