...
int Unifill_obj::uLength( ::String s){
	...
	{
		HX_STACK_LINE(14)
		::luxe::utils::unifill::Utf8 tmp1 = ::luxe::utils::unifill::Utf8_obj::__new(s);		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(14)
		::luxe::utils::unifill::Utf8 u = tmp1;		HX_STACK_VAR(u,"u");
		HX_STACK_LINE(14)
		int tmp2 = s.length;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(14)
		tmp = u->codePointCount((int)0,tmp2);
	}
	HX_STACK_LINE(14)
	return tmp;
}
...
::String Unifill_obj::uCharAt( ::String s,int index){
	...
	HX_STACK_LINE(21)
	{
		...
		{
			HX_STACK_LINE(21)
			::luxe::utils::unifill::Utf8 tmp4;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(21)
			{
				HX_STACK_LINE(21)
				...
				HX_STACK_LINE(21)
				tmp4 = ::luxe::utils::unifill::Utf8_obj::__new(tmp8);
			}
			HX_STACK_LINE(21)
			::luxe::utils::unifill::Utf8 _this = tmp4;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(21)
			tmp = _this->str;
		}
	}
	...
	HX_STACK_ARG(startIndex,"startIndex")
{
		...
		{
			HX_STACK_LINE(53)
			::luxe::utils::unifill::Utf8 tmp2 = ::luxe::utils::unifill::Utf8_obj::__new(s);		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(53)
			::luxe::utils::unifill::Utf8 u = tmp2;		HX_STACK_VAR(u,"u");
			HX_STACK_LINE(53)
			...
			if ((tmp3)){
				...
				HX_STACK_LINE(53)
				int tmp4 = u->str.length;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(53)
					...
					HX_STACK_LINE(53)
					{
						...
						if ((tmp15)){
							...
							if ((tmp19)){
								...
								HX_STACK_LINE(53)
								int tmp21 = accessor(tmp20).Cast< int >();		HX_STACK_VAR(tmp21,"tmp21");
								HX_STACK_LINE(53)
								...
								if ((tmp23)){
									...
									HX_STACK_LINE(53)
									int tmp25 = accessor(tmp24).Cast< int >();		HX_STACK_VAR(tmp25,"tmp25");
									HX_STACK_LINE(53)
		...
		if ((tmp3)){
			HX_STACK_LINE(54)
			::luxe::utils::unifill::Utf8 tmp5 = ::luxe::utils::unifill::Utf8_obj::__new(s);		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(54)
...
int Unifill_obj::uLastIndexOf( ::String s,::String value,Dynamic startIndex){
	...
	HX_STACK_LINE(65)
	{
		...
		HX_STACK_LINE(65)
		::luxe::utils::unifill::Utf8 tmp3 = ::luxe::utils::unifill::Utf8_obj::__new(s);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(65)
		::luxe::utils::unifill::Utf8 u = tmp3;		HX_STACK_VAR(u,"u");
		HX_STACK_LINE(65)
	...
	if ((tmp4)){
		HX_STACK_LINE(66)
		::luxe::utils::unifill::Utf8 tmp6 = ::luxe::utils::unifill::Utf8_obj::__new(s);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(66)
		::luxe::utils::unifill::Utf8 u = tmp6;		HX_STACK_VAR(u,"u");
		HX_STACK_LINE(66)
		int tmp7 = index;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(66)
		tmp5 = u->codePointCount((int)0,tmp7);
	}
	else{
		HX_STACK_LINE(66)
		tmp5 = (int)-1;
		...
		HX_STACK_LINE(74)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(74)
				{
					...
					{
						HX_STACK_LINE(74)
						::luxe::utils::unifill::Utf8 tmp6 = ::luxe::utils::unifill::Utf8_obj::__new(_g1->string);		HX_STACK_VAR(tmp6,"tmp6");
						HX_STACK_LINE(74)
						::luxe::utils::unifill::Utf8 u = tmp6;		HX_STACK_VAR(u,"u");
						HX_STACK_LINE(74)
						{
							HX_STACK_LINE(74)
							int tmp7 = _g1->index;		HX_STACK_VAR(tmp7,"tmp7");
							HX_STACK_LINE(74)
							int tmp8 = u->str.cca(tmp7);		HX_STACK_VAR(tmp8,"tmp8");
							HX_STACK_LINE(74)
					...
					HX_STACK_LINE(74)
					{
						...
						HX_STACK_LINE(74)
						{
							...
							HX_STACK_LINE(74)
							{
								...
								HX_STACK_LINE(74)
								::String tmp11 = u->str.substr(tmp9,tmp10);		HX_STACK_VAR(tmp11,"tmp11");
								HX_STACK_LINE(74)
						...
						HX_STACK_LINE(74)
						::luxe::utils::unifill::Utf8 tmp8 = ::luxe::utils::unifill::Utf8_obj::__new(tmp7);		HX_STACK_VAR(tmp8,"tmp8");
						HX_STACK_LINE(74)
						::luxe::utils::unifill::Utf8 _this = tmp8;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(74)
						tmp5 = _this->str;
					}
				}
...
::String Unifill_obj::uSubstr( ::String s,int startIndex,Dynamic length){
	...
	HX_STACK_LINE(86)
	{
		...
		::luxe::utils::unifill::Utf8 u = tmp3;		HX_STACK_VAR(u,"u");
		HX_STACK_LINE(86)
		bool tmp4 = (startIndex >= (int)0);		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(86)
		if ((tmp4)){
			HX_STACK_LINE(86)
			...
			while((true)){
				HX_STACK_LINE(86)
				bool tmp6 = (i < startIndex);		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(86)
				bool tmp7;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(86)
				if ((tmp6)){
	...
	if ((tmp1)){
		...
		if ((tmp3)){
			...
			HX_STACK_LINE(91)
			::luxe::utils::unifill::Utf8 tmp4 = ::luxe::utils::unifill::Utf8_obj::__new(s);		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(91)
			...
			if ((tmp5)){
				...
				HX_STACK_LINE(91)
				int tmp6 = u->str.length;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(91)
				...
				while((true)){
					...
					HX_STACK_LINE(91)
					{
						...
						HX_STACK_LINE(91)
						int tmp14 = accessor(tmp13).Cast< int >();		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(91)
						...
						if ((tmp17)){
							...
							if ((tmp21)){
								...
								if ((tmp25)){
									...
									HX_STACK_LINE(91)
									int tmp27 = accessor(tmp26).Cast< int >();		HX_STACK_VAR(tmp27,"tmp27");
									HX_STACK_LINE(91)
	...
	if ((tmp2)){
		...
		if ((tmp4)){
			...
			if ((tmp6)){
				...
				int index = (int)0;		HX_STACK_VAR(index,"index");
				HX_STACK_LINE(105)
				int tmp7 = u->str.length;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(105)
						...
						if ((tmp18)){
							...
							if ((tmp22)){
								...
								if ((tmp26)){
									...
									HX_STACK_LINE(105)
									int tmp28 = accessor(tmp27).Cast< int >();		HX_STACK_VAR(tmp28,"tmp28");
									HX_STACK_LINE(105)
...
int Unifill_obj::uCompare( ::String a,::String b){
	...
	while((true)){
		...
		HX_STACK_LINE(123)
		{
			...
			{
				HX_STACK_LINE(123)
				int i = aiter->index;		HX_STACK_VAR(i,"i");
				HX_STACK_LINE(123)
				int tmp7;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(123)
				{
					HX_STACK_LINE(123)
					::luxe::utils::unifill::Utf8 tmp8 = ::luxe::utils::unifill::Utf8_obj::__new(aiter->string);		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(123)
					::luxe::utils::unifill::Utf8 u = tmp8;		HX_STACK_VAR(u,"u");
					HX_STACK_LINE(123)
					{
						HX_STACK_LINE(123)
						int tmp9 = aiter->index;		HX_STACK_VAR(tmp9,"tmp9");
						HX_STACK_LINE(123)
						int tmp10 = u->str.cca(tmp9);		HX_STACK_VAR(tmp10,"tmp10");
						HX_STACK_LINE(123)
						int c = tmp10;		HX_STACK_VAR(c,"c");
			...
			HX_STACK_LINE(123)
			::luxe::utils::unifill::Utf8 tmp7 = ::luxe::utils::unifill::Utf8_obj::__new(a);		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(123)
			::luxe::utils::unifill::Utf8 u = tmp7;		HX_STACK_VAR(u,"u");
			HX_STACK_LINE(123)
			int tmp8 = index;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(123)
			tmp5 = u->codePointAt(tmp8);
		}
		HX_STACK_LINE(123)
		...
		HX_STACK_LINE(124)
		{
			...
			{
				HX_STACK_LINE(124)
				int i = biter->index;		HX_STACK_VAR(i,"i");
				HX_STACK_LINE(124)
				int tmp8;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(124)
				{
					HX_STACK_LINE(124)
					::luxe::utils::unifill::Utf8 tmp9 = ::luxe::utils::unifill::Utf8_obj::__new(biter->string);		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(124)
					::luxe::utils::unifill::Utf8 u = tmp9;		HX_STACK_VAR(u,"u");
					HX_STACK_LINE(124)
					{
						HX_STACK_LINE(124)
						int tmp10 = biter->index;		HX_STACK_VAR(tmp10,"tmp10");
						HX_STACK_LINE(124)
						int tmp11 = u->str.cca(tmp10);		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(124)
						int c = tmp11;		HX_STACK_VAR(c,"c");
			...
			HX_STACK_LINE(124)
			::luxe::utils::unifill::Utf8 tmp8 = ::luxe::utils::unifill::Utf8_obj::__new(b);		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(124)
			::luxe::utils::unifill::Utf8 u = tmp8;		HX_STACK_VAR(u,"u");
			HX_STACK_LINE(124)
			int tmp9 = index;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(124)
			tmp6 = u->codePointAt(tmp9);
		}
		HX_STACK_LINE(124)
