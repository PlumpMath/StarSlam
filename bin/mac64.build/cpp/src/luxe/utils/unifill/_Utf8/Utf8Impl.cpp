...
int Utf8Impl_obj::code_point_width( int c){
	HX_STACK_FRAME("luxe.utils.unifill._Utf8.Utf8Impl","code_point_width",0xe8ec57d4,"luxe.utils.unifill._Utf8.Utf8Impl.code_point_width","luxe/utils/unifill/Utf8.hx",168,0xbecfbbba)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(169)
...
{
		HX_STACK_FRAME("luxe.utils.unifill._Utf8.Utf8Impl","encode_code_point",0xd40a54d8,"luxe.utils.unifill._Utf8.Utf8Impl.encode_code_point","luxe/utils/unifill/Utf8.hx",181,0xbecfbbba)
