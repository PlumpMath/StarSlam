...
::String StringU8_Impl__obj::fromString( ::String s){
	HX_STACK_FRAME("luxe.utils.unifill._Utf8.StringU8_Impl_","fromString",0x27489647,"luxe.utils.unifill._Utf8.StringU8_Impl_.fromString","luxe/utils/unifill/Utf8.hx",253,0xbecfbbba)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(254)
...
::String StringU8_Impl__obj::ofBytes( ::haxe::io::Bytes b){
	HX_STACK_FRAME("luxe.utils.unifill._Utf8.StringU8_Impl_","ofBytes",0x70201fe8,"luxe.utils.unifill._Utf8.StringU8_Impl_.ofBytes","luxe/utils/unifill/Utf8.hx",257,0xbecfbbba)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(258)
...
::String StringU8_Impl__obj::fromBytes( ::haxe::io::Bytes b){
	HX_STACK_FRAME("luxe.utils.unifill._Utf8.StringU8_Impl_","fromBytes",0xda647bb5,"luxe.utils.unifill._Utf8.StringU8_Impl_.fromBytes","luxe/utils/unifill/Utf8.hx",261,0xbecfbbba)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(262)
	::String tmp;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(262)
...
int StringU8_Impl__obj::codeUnitAt( ::String this1,int index){
	HX_STACK_FRAME("luxe.utils.unifill._Utf8.StringU8_Impl_","codeUnitAt",0xfe22da10,"luxe.utils.unifill._Utf8.StringU8_Impl_.codeUnitAt","luxe/utils/unifill/Utf8.hx",267,0xbecfbbba)
...
::String StringU8_Impl__obj::substr( ::String this1,int index,Dynamic len){
	HX_STACK_FRAME("luxe.utils.unifill._Utf8.StringU8_Impl_","substr",0xaf0fb19d,"luxe.utils.unifill._Utf8.StringU8_Impl_.substr","luxe/utils/unifill/Utf8.hx",271,0xbecfbbba)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(index,"index")
...
::String StringU8_Impl__obj::toString( ::String this1){
	HX_STACK_FRAME("luxe.utils.unifill._Utf8.StringU8_Impl_","toString",0x29fa0618,"luxe.utils.unifill._Utf8.StringU8_Impl_.toString","luxe/utils/unifill/Utf8.hx",275,0xbecfbbba)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(276)
...
::haxe::io::Bytes StringU8_Impl__obj::toBytes( ::String this1){
	HX_STACK_FRAME("luxe.utils.unifill._Utf8.StringU8_Impl_","toBytes",0xd941b104,"luxe.utils.unifill._Utf8.StringU8_Impl_.toBytes","luxe/utils/unifill/Utf8.hx",279,0xbecfbbba)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(280)
	::String tmp = this1;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(280)
...
int StringU8_Impl__obj::get_length( ::String this1){
	HX_STACK_FRAME("luxe.utils.unifill._Utf8.StringU8_Impl_","get_length",0x62636d1b,"luxe.utils.unifill._Utf8.StringU8_Impl_.get_length","luxe/utils/unifill/Utf8.hx",287,0xbecfbbba)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(288)
