...
::String CodePoint_Impl__obj::snoc( ::String a,int b){
	...
	{
		HX_STACK_LINE(11)
		::luxe::utils::unifill::Utf8 tmp2;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(11)
		{
			HX_STACK_LINE(11)
			...
			HX_STACK_LINE(11)
			tmp2 = ::luxe::utils::unifill::Utf8_obj::__new(tmp6);
		}
		HX_STACK_LINE(11)
		::luxe::utils::unifill::Utf8 _this = tmp2;		HX_STACK_VAR(_this,"_this");
		HX_STACK_LINE(11)
		tmp1 = _this->str;
	}
	HX_STACK_LINE(11)
