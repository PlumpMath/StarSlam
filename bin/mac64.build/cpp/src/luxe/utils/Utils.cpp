...
::String _start = __o__start.Default(HX_HCSTRING("1","\x31","\x00","\x00","\x00"));
	HX_STACK_FRAME("luxe.utils.Utils","find_assets_image_sequence",0x66eeea6d,"luxe.utils.Utils.find_assets_image_sequence","luxe/utils/Utils.hx",144,0x2d9d0da4)
	HX_STACK_THIS(this)
	...
	HX_STACK_ARG(_start,"_start")
{
		...
		if ((tmp24)){
			...
			if ((tmp27)){
				...
				if ((tmp30)){
					...
					HX_STACK_LINE(170)
					Dynamic tmp42 = hx::SourceInfo(HX_HCSTRING("Utils.hx","\x4d","\x09","\x60","\x4c"),170,HX_HCSTRING("luxe.utils.Utils","\x5c","\x3f","\x34","\xb4"),HX_HCSTRING("find_assets_image_sequence","\x9b","\xda","\x5d","\x1e"));		HX_STACK_VAR(tmp42,"tmp42");
					HX_STACK_LINE(170)
		...
		if ((tmp25)){
			HX_STACK_LINE(174)
			{
				...
				HX_STACK_LINE(174)
				::snow::_system::assets::Assets tmp27 = tmp26->app->assets;		HX_STACK_VAR(tmp27,"tmp27");
				HX_STACK_LINE(174)
				Array< ::String > _g1 = tmp27->__Field(HX_HCSTRING("list","\x5e","\x1c","\xb3","\x47"), hx::paccDynamic );		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(174)
				while((true)){
					HX_STACK_LINE(174)
					...
					HX_STACK_LINE(174)
					::String tmp30 = _g1->__get(_g);		HX_STACK_VAR(tmp30,"tmp30");
					HX_STACK_LINE(174)
					::String _asset = tmp30;		HX_STACK_VAR(_asset,"_asset");
					HX_STACK_LINE(174)
					++(_g);
					HX_STACK_LINE(176)
					::String tmp31 = _asset;		HX_STACK_VAR(tmp31,"tmp31");
					HX_STACK_LINE(176)
					bool tmp32 = _pattern_regex->match(tmp31);		HX_STACK_VAR(tmp32,"tmp32");
					HX_STACK_LINE(176)
					if ((tmp32)){
						HX_STACK_LINE(177)
						::String tmp33 = _asset;		HX_STACK_VAR(tmp33,"tmp33");
						HX_STACK_LINE(177)
						_final->push(tmp33);
					}
				}
			...
			int run(::String a,::String b){
				...
				{
					HX_STACK_LINE(181)
					bool tmp26 = (a == b);		HX_STACK_VAR(tmp26,"tmp26");
					HX_STACK_LINE(181)
					if ((tmp26)){
						HX_STACK_LINE(181)
						return (int)0;
					...
					HX_STACK_LINE(181)
					bool tmp27 = (a < b);		HX_STACK_VAR(tmp27,"tmp27");
					HX_STACK_LINE(181)
					if ((tmp27)){
						HX_STACK_LINE(181)
						return (int)-1;
...
static ::String sMemberFields[] = {
	...
	HX_HCSTRING("find_assets_image_sequence","\x9b","\xda","\x5d","\x1e"),
