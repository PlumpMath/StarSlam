			...
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","luxe/Parcel.hx",151,0x19b0ca9c)
			{
				...
				if ((tmp17)){
					HX_STACK_LINE(167)
					{
						...
						HX_STACK_LINE(167)
						_g->emitter->emit((int)2,tmp22);
						HX_STACK_LINE(167)
						bool tmp23 = (_g->oncomplete != null());		HX_STACK_VAR(tmp23,"tmp23");
						HX_STACK_LINE(167)
						if ((tmp23)){
							HX_STACK_LINE(167)
							::luxe::Parcel tmp24 = _g;		HX_STACK_VAR(tmp24,"tmp24");
							HX_STACK_LINE(167)
							_g->oncomplete(tmp24);
						}
					}
...
Void Parcel_obj::from_json( Dynamic _json_object){
{
		...
		HX_STACK_LINE(380)
		{
			...
			if ((tmp)){
				HX_STACK_LINE(380)
				::luxe::DebugError tmp1 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("_json_object was null","\xe7","\x68","\xbd","\x92"));		HX_STACK_VAR(tmp1,"tmp1");
				HX_STACK_LINE(380)
				...
				while((true)){
					...
					if ((tmp4)){
						HX_STACK_LINE(386)
						{
							...
							if ((tmp5)){
								HX_STACK_LINE(386)
								::luxe::DebugError tmp6 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("item was null","\x8b","\x59","\x54","\x85"));		HX_STACK_VAR(tmp6,"tmp6");
								HX_STACK_LINE(386)
						...
						HX_STACK_LINE(387)
						{
							...
							if ((tmp5)){
								HX_STACK_LINE(387)
								::luxe::DebugError tmp6 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("item.id was null","\xe8","\xf1","\x00","\xe6"));		HX_STACK_VAR(tmp6,"tmp6");
								HX_STACK_LINE(387)
								HX_STACK_DO_THROW(tmp6);
							}
						}
				...
				while((true)){
					...
					if ((tmp5)){
						HX_STACK_LINE(398)
						{
							...
							if ((tmp6)){
								HX_STACK_LINE(398)
								::luxe::DebugError tmp7 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("item was null","\x8b","\x59","\x54","\x85"));		HX_STACK_VAR(tmp7,"tmp7");
								HX_STACK_LINE(398)
						...
						HX_STACK_LINE(399)
						{
							...
							if ((tmp6)){
								HX_STACK_LINE(399)
								::luxe::DebugError tmp7 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("item.id was null","\xe8","\xf1","\x00","\xe6"));		HX_STACK_VAR(tmp7,"tmp7");
								HX_STACK_LINE(399)
								HX_STACK_DO_THROW(tmp7);
							}
						}
				...
				while((true)){
					...
					if ((tmp6)){
						HX_STACK_LINE(410)
						{
							...
							if ((tmp7)){
								HX_STACK_LINE(410)
								::luxe::DebugError tmp8 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("item was null","\x8b","\x59","\x54","\x85"));		HX_STACK_VAR(tmp8,"tmp8");
								HX_STACK_LINE(410)
						...
						HX_STACK_LINE(411)
						{
							...
							if ((tmp7)){
								HX_STACK_LINE(411)
								::luxe::DebugError tmp8 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("item.id was null","\xe8","\xf1","\x00","\xe6"));		HX_STACK_VAR(tmp8,"tmp8");
								HX_STACK_LINE(411)
								HX_STACK_DO_THROW(tmp8);
							}
						}
					...
					HX_STACK_LINE(447)
					{
						...
						if ((tmp9)){
							...
							HX_STACK_LINE(447)
							{
								...
								if ((tmp13)){
									HX_STACK_LINE(447)
									::luxe::DebugError tmp14 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("_filter_type == 'nearest' || _filter_type == 'linear'","\xcb","\x04","\xdb","\xd6"));		HX_STACK_VAR(tmp14,"tmp14");
									HX_STACK_LINE(447)
					...
					HX_STACK_LINE(448)
					{
						...
						if ((tmp10)){
							...
							HX_STACK_LINE(448)
							{
								...
								if ((tmp14)){
									HX_STACK_LINE(448)
									::luxe::DebugError tmp15 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("_filter_type == 'nearest' || _filter_type == 'linear'","\xcb","\x04","\xdb","\xd6"));		HX_STACK_VAR(tmp15,"tmp15");
									HX_STACK_LINE(448)
					...
					HX_STACK_LINE(449)
					{
						...
						if ((tmp11)){
							...
							HX_STACK_LINE(449)
							{
								...
								if ((tmp18)){
									HX_STACK_LINE(449)
									::luxe::DebugError tmp19 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("_clamp_type == 'edge' || _clamp_type == 'repeat' || _clamp_type == 'mirror'","\x5c","\xa3","\xdf","\xbb"));		HX_STACK_VAR(tmp19,"tmp19");
									HX_STACK_LINE(449)
					...
					HX_STACK_LINE(450)
					{
						...
						if ((tmp12)){
							...
							HX_STACK_LINE(450)
							{
								...
								if ((tmp19)){
									HX_STACK_LINE(450)
									::luxe::DebugError tmp20 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("_clamp_type == 'edge' || _clamp_type == 'repeat' || _clamp_type == 'mirror'","\x5c","\xa3","\xdf","\xbb"));		HX_STACK_VAR(tmp20,"tmp20");
									HX_STACK_LINE(450)
				...
				while((true)){
					...
					if ((tmp8)){
						HX_STACK_LINE(461)
						{
							...
							if ((tmp9)){
								HX_STACK_LINE(461)
								::luxe::DebugError tmp10 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("item was null","\x8b","\x59","\x54","\x85"));		HX_STACK_VAR(tmp10,"tmp10");
								HX_STACK_LINE(461)
						...
						HX_STACK_LINE(462)
						{
							...
							if ((tmp9)){
								HX_STACK_LINE(462)
								::luxe::DebugError tmp10 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("item.id was null","\xe8","\xf1","\x00","\xe6"));		HX_STACK_VAR(tmp10,"tmp10");
								HX_STACK_LINE(462)
								HX_STACK_DO_THROW(tmp10);
							}
						}
				...
				while((true)){
					...
					if ((tmp9)){
						HX_STACK_LINE(473)
						{
							...
							if ((tmp10)){
								HX_STACK_LINE(473)
								::luxe::DebugError tmp11 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("item was null","\x8b","\x59","\x54","\x85"));		HX_STACK_VAR(tmp11,"tmp11");
								HX_STACK_LINE(473)
						...
						HX_STACK_LINE(474)
						{
							...
							if ((tmp10)){
								HX_STACK_LINE(474)
								::luxe::DebugError tmp11 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("item.id was null","\xe8","\xf1","\x00","\xe6"));		HX_STACK_VAR(tmp11,"tmp11");
								HX_STACK_LINE(474)
								HX_STACK_DO_THROW(tmp11);
							}
						}
						HX_STACK_LINE(475)
						{
							...
							if ((tmp10)){
								HX_STACK_LINE(475)
								::luxe::DebugError tmp11 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("item.frag_id was null","\xb1","\x05","\x52","\x6e"));		HX_STACK_VAR(tmp11,"tmp11");
								HX_STACK_LINE(475)
								HX_STACK_DO_THROW(tmp11);
							}
						}
						HX_STACK_LINE(476)
						{
							...
							if ((tmp10)){
								HX_STACK_LINE(476)
								::luxe::DebugError tmp11 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("item.vert_id was null","\xb0","\x63","\xd6","\xc8"));		HX_STACK_VAR(tmp11,"tmp11");
								HX_STACK_LINE(476)
								HX_STACK_DO_THROW(tmp11);
							}
						}
				...
				while((true)){
					...
					if ((tmp10)){
						HX_STACK_LINE(487)
						{
							...
							if ((tmp11)){
								HX_STACK_LINE(487)
								::luxe::DebugError tmp12 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("item was null","\x8b","\x59","\x54","\x85"));		HX_STACK_VAR(tmp12,"tmp12");
								HX_STACK_LINE(487)
						...
						HX_STACK_LINE(488)
						{
							...
							if ((tmp11)){
								HX_STACK_LINE(488)
								::luxe::DebugError tmp12 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("item.id was null","\xe8","\xf1","\x00","\xe6"));		HX_STACK_VAR(tmp12,"tmp12");
								HX_STACK_LINE(488)
								HX_STACK_DO_THROW(tmp12);
							}
						}
						HX_STACK_LINE(489)
						{
							...
							if ((tmp11)){
								HX_STACK_LINE(489)
								::luxe::DebugError tmp12 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("item.name was null","\xb8","\xa0","\x41","\xe7"));		HX_STACK_VAR(tmp12,"tmp12");
								HX_STACK_LINE(489)
								HX_STACK_DO_THROW(tmp12);
							}
						}
...
Void Parcel_obj::one_loaded( ::String _item_id,::String _load_id,::luxe::resource::Resource _resource,int _index,int _total){
{
		...
		if ((tmp5)){
			...
			HX_STACK_LINE(521)
			Float tmp8 = this->start_load;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(521)
			Float tmp9 = (tmp7 - tmp8);		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(521)
			this->time_to_load = tmp9;
			HX_STACK_LINE(521)
			::luxe::Emitter tmp10 = this->emitter;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(521)
			tmp10->emit((int)2,hx::ObjectPtr<OBJ_>(this));
			HX_STACK_LINE(521)
...
Void Parcel_obj::do_complete( ::String _load_id){
{
		...
		HX_STACK_LINE(583)
		Dynamic tmp5 = this->oncomplete_dyn();		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(583)
