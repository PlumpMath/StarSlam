...
{
HX_STACK_FRAME("luxe.PhysicsEngine","new",0x3df79a83,"luxe.PhysicsEngine.new","luxe/Physics.hx",159,0xe794c970)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(165)
	this->draw = true;
...
{
		HX_STACK_FRAME("luxe.PhysicsEngine","init",0xf7684f8d,"luxe.PhysicsEngine.init","luxe/Physics.hx",174,0xe794c970)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("luxe.PhysicsEngine","_render",0xd6f79498,"luxe.PhysicsEngine._render","luxe/Physics.hx",180,0xe794c970)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_,"_")
		HX_STACK_LINE(180)
		this->render();
...
{
		HX_STACK_FRAME("luxe.PhysicsEngine","process",0x54a1ba12,"luxe.PhysicsEngine.process","luxe/Physics.hx",184,0xe794c970)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("luxe.PhysicsEngine","update",0xcd7e73c6,"luxe.PhysicsEngine.update","luxe/Physics.hx",188,0xe794c970)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("luxe.PhysicsEngine","render",0x4ba25913,"luxe.PhysicsEngine.render","luxe/Physics.hx",192,0xe794c970)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("luxe.PhysicsEngine","destroy",0x87dd449d,"luxe.PhysicsEngine.destroy","luxe/Physics.hx",196,0xe794c970)
		HX_STACK_THIS(this)
	}
return null();
}
...
bool PhysicsEngine_obj::get_paused( ){
	HX_STACK_FRAME("luxe.PhysicsEngine","get_paused",0x8cbac0b4,"luxe.PhysicsEngine.get_paused","luxe/Physics.hx",202,0xe794c970)
	HX_STACK_THIS(this)
	HX_STACK_LINE(204)
...
bool PhysicsEngine_obj::set_paused( Dynamic _pause){
	HX_STACK_FRAME("luxe.PhysicsEngine","set_paused",0x90385f28,"luxe.PhysicsEngine.set_paused","luxe/Physics.hx",208,0xe794c970)
	HX_STACK_THIS(this)
...
bool PhysicsEngine_obj::get_draw( ){
	HX_STACK_FRAME("luxe.PhysicsEngine","get_draw",0x4b087e8a,"luxe.PhysicsEngine.get_draw","luxe/Physics.hx",214,0xe794c970)
	HX_STACK_THIS(this)
	HX_STACK_LINE(216)
...
bool PhysicsEngine_obj::set_draw( bool _draw){
	HX_STACK_FRAME("luxe.PhysicsEngine","set_draw",0xf965d7fe,"luxe.PhysicsEngine.set_draw","luxe/Physics.hx",220,0xe794c970)
	HX_STACK_THIS(this)
...
::phoenix::Vector PhysicsEngine_obj::get_gravity( ){
	HX_STACK_FRAME("luxe.PhysicsEngine","get_gravity",0x6a78f388,"luxe.PhysicsEngine.get_gravity","luxe/Physics.hx",226,0xe794c970)
	HX_STACK_THIS(this)
	HX_STACK_LINE(228)
...
::phoenix::Vector PhysicsEngine_obj::set_gravity( ::phoenix::Vector _gravity){
	HX_STACK_FRAME("luxe.PhysicsEngine","set_gravity",0x74e5fa94,"luxe.PhysicsEngine.set_gravity","luxe/Physics.hx",232,0xe794c970)
	HX_STACK_THIS(this)
