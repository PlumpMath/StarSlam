...
Dynamic Physics_obj::add_engine( ::hx::Class type,Dynamic _data){
	HX_STACK_FRAME("luxe.Physics","add_engine",0x7161177f,"luxe.Physics.add_engine","luxe/Physics.hx",89,0xe794c970)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("luxe.Physics","update",0x8de504a8,"luxe.Physics.update","luxe/Physics.hx",107,0xe794c970)
		HX_STACK_THIS(this)
		HX_STACK_LINE(107)
...
{
		HX_STACK_FRAME("luxe.Physics","process",0xedf9eef0,"luxe.Physics.process","luxe/Physics.hx",113,0xe794c970)
		HX_STACK_THIS(this)
		HX_STACK_LINE(113)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(113)
...
{
		HX_STACK_FRAME("luxe.Physics","render",0x0c08e9f5,"luxe.Physics.render","luxe/Physics.hx",119,0xe794c970)
		HX_STACK_THIS(this)
		HX_STACK_LINE(119)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(119)
...
{
		HX_STACK_FRAME("luxe.Physics","destroy",0x2135797b,"luxe.Physics.destroy","luxe/Physics.hx",124,0xe794c970)
		HX_STACK_THIS(this)
		HX_STACK_LINE(126)
		::snow::api::Timer tmp = this->timer;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(126)
...
Float Physics_obj::set_step_rate( Float _rate){
	HX_STACK_FRAME("luxe.Physics","set_step_rate",0x5fde6d17,"luxe.Physics.set_step_rate","luxe/Physics.hx",139,0xe794c970)
	HX_STACK_THIS(this)
