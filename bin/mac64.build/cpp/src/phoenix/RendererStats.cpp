...
{
		HX_STACK_FRAME("phoenix.RendererStats","reset",0xee7deb3e,"phoenix.RendererStats.reset","phoenix/Renderer.hx",395,0x3d4c7b7b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(396)
		this->geometry_count = (int)0;
		HX_STACK_LINE(397)
...
::String RendererStats_obj::toString( ){
	HX_STACK_FRAME("phoenix.RendererStats","toString",0xe4927e9d,"phoenix.RendererStats.toString","phoenix/Renderer.hx",405,0x3d4c7b7b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(407)
...
void RendererStats_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("group_count","\x8f","\xb8","\x0f","\x8d"));
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(RendererStats_obj,group_count),HX_HCSTRING("group_count","\x8f","\xb8","\x0f","\x8d")},
...
static ::String sMemberFields[] = {
	...
	HX_HCSTRING("group_count","\x8f","\xb8","\x0f","\x8d"),
