...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(568)
	{
		...
		HX_STACK_LINE(568)
		cpp::ArrayBase array = tmp1->elements;		HX_STACK_VAR(array,"array");
		HX_STACK_LINE(568)
		::snow::api::buffers::ArrayBufferView this1;		HX_STACK_VAR(this1,"this1");
		HX_STACK_LINE(568)
		...
		if ((tmp2)){
			HX_STACK_LINE(568)
			::snow::api::buffers::ArrayBufferView tmp3 = ::snow::api::buffers::ArrayBufferView_obj::__new(null(),(int)8);		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(568)
			this1 = tmp3;
		}
		else{
		...
		HX_STACK_LINE(580)
		{
			...
			if ((tmp)){
				...
				HX_STACK_LINE(580)
				{
					...
					HX_STACK_LINE(580)
					cpp::ArrayBase array = tmp2->elements;		HX_STACK_VAR(array,"array");
					HX_STACK_LINE(580)
					::snow::api::buffers::ArrayBufferView this1;		HX_STACK_VAR(this1,"this1");
					HX_STACK_LINE(580)
					...
					if ((tmp3)){
						HX_STACK_LINE(580)
						::snow::api::buffers::ArrayBufferView tmp4 = ::snow::api::buffers::ArrayBufferView_obj::__new(null(),(int)8);		HX_STACK_VAR(tmp4,"tmp4");
						HX_STACK_LINE(580)
						this1 = tmp4;
					}
					else{
