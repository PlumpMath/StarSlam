...
::phoenix::Vector Vector_obj::add( ::phoenix::Vector other){
	...
	HX_STACK_LINE(335)
	{
		...
		if ((tmp)){
			HX_STACK_LINE(335)
			::luxe::DebugError tmp1 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("other was null","\x2e","\x18","\x3c","\x9a"));		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(335)
...
::phoenix::Vector Vector_obj::divide( ::phoenix::Vector other){
	...
	HX_STACK_LINE(391)
	{
		...
		if ((tmp1)){
			HX_STACK_LINE(391)
			::luxe::DebugError tmp2 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("other.x != 0 (Vector: division by zero (other.x))","\xd1","\x2c","\x13","\x38"));		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(391)
	...
	HX_STACK_LINE(392)
	{
		...
		if ((tmp1)){
			HX_STACK_LINE(392)
			::luxe::DebugError tmp2 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("other.y != 0 (Vector: division by zero (other.y))","\x53","\xfe","\x92","\x17"));		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(392)
			HX_STACK_DO_THROW(tmp2);
		}
	}
	...
	HX_STACK_ARG(_z,"_z")
{
		HX_STACK_LINE(402)
		{
			...
			if ((tmp1)){
				HX_STACK_LINE(402)
				::luxe::DebugError tmp2 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("_x != 0 (Vector.divide_xyz: division by zero (x))","\xe9","\x12","\x95","\x81"));		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(402)
				HX_STACK_DO_THROW(tmp2);
			}
		}
		HX_STACK_LINE(403)
		{
			...
			if ((tmp1)){
				HX_STACK_LINE(403)
				::luxe::DebugError tmp2 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("_y != 0 (Vector.divide_xyz: division by zero (y))","\x49","\xda","\x52","\x6d"));		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(403)
				HX_STACK_DO_THROW(tmp2);
			}
		}
		HX_STACK_LINE(404)
		{
			...
			if ((tmp1)){
				HX_STACK_LINE(404)
				::luxe::DebugError tmp2 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("_z != 0 (Vector.divide_xyz: division by zero (z))","\xa9","\xa1","\x10","\x59"));		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(404)
				HX_STACK_DO_THROW(tmp2);
			}
		}
