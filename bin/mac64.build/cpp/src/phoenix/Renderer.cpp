...
Void Renderer_obj::init( ){
{
		...
		HX_STACK_LINE(110)
		tmp13->set_layer((int)1);
		HX_STACK_LINE(111)
		::phoenix::Batcher tmp14 = this->batcher;		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(111)
		this->add_batch(tmp14);
		HX_STACK_LINE(115)
		this->create_default_font();
		HX_STACK_LINE(119)
		::luxe::Core tmp15 = ::Luxe_obj::core;		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(119)
		Dynamic tmp16 = tmp15->app->config;		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(119)
		Dynamic tmp17 = tmp16->__Field(HX_HCSTRING("render","\x56","\x6b","\x29","\x05"), hx::paccDynamic )->__Field(HX_HCSTRING("depth","\x03","\xf1","\x29","\xd7"), hx::paccDynamic );		HX_STACK_VAR(tmp17,"tmp17");
		HX_STACK_LINE(119)
		if ((tmp17)){
			HX_STACK_LINE(121)
...
::phoenix::Batcher Renderer_obj::create_batcher( Dynamic options){
	...
	HX_STACK_LINE(189)
	Dynamic tmp2 = options->__Field(HX_HCSTRING("layer","\xd1","\x81","\xc0","\x6f"), hx::paccDynamic );		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(189)
	_batcher->set_layer(tmp2);
	HX_STACK_LINE(191)
	bool tmp3 = (options->__Field(HX_HCSTRING("no_add","\xe3","\x4b","\xd1","\x23"), hx::paccDynamic ) == null());		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(191)
	...
	if ((tmp4)){
		HX_STACK_LINE(191)
		tmp5 = (options->__Field(HX_HCSTRING("no_add","\xe3","\x4b","\xd1","\x23"), hx::paccDynamic ) == false);
	}
	else{
		HX_STACK_LINE(191)
		tmp5 = true;
	...
	if ((tmp5)){
		HX_STACK_LINE(192)
		::phoenix::Batcher tmp6 = _batcher;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(192)
		this->add_batch(tmp6);
	}
	HX_STACK_LINE(195)
...
Void Renderer_obj::create_default_shaders( ){
{
		...
		HX_STACK_LINE(337)
		{
			...
			if ((tmp17)){
				HX_STACK_LINE(337)
				::luxe::DebugError tmp18 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("_ok (Default shaders failed to compile or link. See log for errors)","\x98","\x7e","\xc8","\x71"));		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(337)
...
Void Renderer_obj::create_default_font( ){
{
		...
		HX_STACK_LINE(353)
		{
			...
			if ((tmp1)){
				HX_STACK_LINE(353)
				::luxe::DebugError tmp2 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("font_asset was null (Renderer / failed to create the default font)","\x52","\xfc","\x95","\xd4"));		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(353)
		...
		HX_STACK_LINE(365)
		{
			...
			if ((tmp8)){
				HX_STACK_LINE(365)
				::luxe::DebugError tmp9 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("_font_texture was null (Renderer / failed to create the default font... font_texture was null.)","\xef","\x88","\x18","\xcd"));		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(365)
