...
HX_STACK_ARG(_options,"_options")
{
	...
	HX_STACK_LINE(71)
	{
		...
		if ((tmp)){
			HX_STACK_LINE(71)
			::luxe::DebugError tmp1 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("_options was null (Texture create requires non-null options)","\x2a","\xcf","\x81","\x3e"));		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(71)
	...
	if ((tmp2)){
		HX_STACK_LINE(89)
		{
			...
			if ((tmp3)){
				HX_STACK_LINE(89)
				::luxe::DebugError tmp4 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("_options.width was null (Texture create with pixels requires both width and height)","\x89","\x82","\x23","\x28"));		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(89)
		...
		HX_STACK_LINE(90)
		{
			...
			if ((tmp3)){
				HX_STACK_LINE(90)
				::luxe::DebugError tmp4 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("_options.height was null (Texture create with pixels requires both width and height)","\xca","\xe3","\x18","\xe6"));		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(90)
				HX_STACK_DO_THROW(tmp4);
			}
		}
	...
	if ((tmp5)){
		HX_STACK_LINE(96)
		{
			...
			if ((tmp6)){
				HX_STACK_LINE(96)
				::luxe::DebugError tmp7 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("_options.height was null (Texture requires both width and height, only width was given in construct options)","\x87","\x3d","\x49","\xab"));		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(96)
		...
		HX_STACK_LINE(97)
		{
			...
			if ((tmp6)){
				HX_STACK_LINE(97)
				::luxe::DebugError tmp7 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("_options.width was null (Texture requires both width and height, only height was given in construct options)","\x71","\xac","\xa5","\x77"));		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(97)
				HX_STACK_DO_THROW(tmp7);
			}
		}
	...
	HX_STACK_ARG(_h,"_h")
{
		HX_STACK_LINE(127)
		{
			...
			if ((tmp)){
				HX_STACK_LINE(127)
				::luxe::DebugError tmp1 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("_into was null (Texture fetch requires a valid buffer to store the pixels.)","\xde","\x8a","\xb3","\x22"));		HX_STACK_VAR(tmp1,"tmp1");
				HX_STACK_LINE(127)
				HX_STACK_DO_THROW(tmp1);
			}
		}
		...
		HX_STACK_LINE(136)
		{
			...
			if ((tmp5)){
				HX_STACK_LINE(136)
				::luxe::DebugError tmp6 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("_into.length >= _required (Texture fetch requires at least $_required (w * h * 4) bytes for the pixels, you have ${_into.length}!)","\x6d","\x7b","\x65","\x0d"));		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(136)
		...
		HX_STACK_LINE(147)
		{
			...
			if ((tmp5)){
				HX_STACK_LINE(147)
				::luxe::DebugError tmp6 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("GL.checkFramebufferStatus(GL.FRAMEBUFFER) == GL.FRAMEBUFFER_COMPLETE","\x57","\xbe","\x3b","\x4b"));		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(147)
				HX_STACK_DO_THROW(tmp6);
			}
		}
	...
	HX_STACK_ARG(_level,"_level")
{
		HX_STACK_LINE(162)
		{
			...
			if ((tmp1)){
				HX_STACK_LINE(162)
				::luxe::DebugError tmp2 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("_level >= 0 (Texture submit level cannot be negative)","\xe7","\x10","\x8a","\xb5"));		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(162)
		...
		HX_STACK_LINE(166)
		{
			...
			if ((tmp4)){
				HX_STACK_LINE(166)
				::luxe::DebugError tmp5 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("width_actual <= _max (Texture actual width bigger than maximum hardware size (width:$width_actual, max:$_max))","\x82","\x8e","\x50","\x57"));		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(166)
		...
		HX_STACK_LINE(167)
		{
			...
			if ((tmp4)){
				HX_STACK_LINE(167)
				::luxe::DebugError tmp5 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("height_actual <= _max (Texture actual height bigger than maximum hardware size (height:$height_actual, max:$_max))","\x1a","\x53","\x6e","\xc9"));		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(167)
				HX_STACK_DO_THROW(tmp5);
			}
		}
		...
		if ((tmp2)){
			...
			if ((tmp3)){
				HX_STACK_LINE(174)
				::luxe::DebugError tmp4 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("_target was null (Texture submit to a non 2D texture requires the _target to be specified)","\xd9","\xe8","\x45","\x3a"));		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(174)
				HX_STACK_DO_THROW(tmp4);
			}
		}
...
::snow::api::Promise Texture_obj::reload( ){
	...
	HX_STACK_LINE(209)
	{
		...
		if ((tmp2)){
			HX_STACK_LINE(209)
			::luxe::DebugError tmp3 = ::luxe::DebugError_obj::assertion(HX_HCSTRING("state != ResourceState.destroyed (Resource cannot reload when already destroyed)","\xe3","\x55","\x7d","\xeb"));		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(209)
