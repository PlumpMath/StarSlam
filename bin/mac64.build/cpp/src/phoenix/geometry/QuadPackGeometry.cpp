...
Void QuadPackGeometry_obj::quad_uv( int _quad_id,::phoenix::Rectangle _uv){
{
		...
		if ((tmp1)){
			HX_STACK_LINE(351)
			Dynamic tmp2 = hx::SourceInfo(HX_HCSTRING("QuadPackGeometry.hx","\xcc","\x27","\x26","\x5e"),351,HX_HCSTRING("phoenix.geometry.QuadPackGeometry","\xcf","\x1b","\x1f","\x2e"),HX_HCSTRING("quad_uv","\x19","\xba","\xfa","\x3e"));		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(351)
			::haxe::Log_obj::trace(HX_HCSTRING("Warning : calling UV on a PackedQuad Geometry with null texture.","\x66","\x55","\x6c","\x54"),tmp2);
			HX_STACK_LINE(352)
			return null();
		}
		HX_STACK_LINE(355)
		Float tmp2 = _uv->x;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(355)
		...
		HX_STACK_LINE(356)
		Float tmp6 = _uv->y;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(356)
		...
		HX_STACK_LINE(357)
		Float tmp10 = _uv->w;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(357)
		...
		HX_STACK_LINE(358)
		Float tmp14 = _uv->h;		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(358)
