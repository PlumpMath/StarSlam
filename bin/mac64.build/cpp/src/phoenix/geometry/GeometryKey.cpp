...
{
HX_STACK_FRAME("phoenix.geometry.GeometryKey","new",0xbf3d7a62,"phoenix.geometry.GeometryKey.new","phoenix/geometry/Geometry.hx",20,0xdab136cf)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(32)
	this->clip = false;
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(GeometryKey_obj,group),HX_HCSTRING("group","\x3f","\xb3","\xf4","\x99")},
