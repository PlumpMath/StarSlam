...
Void PlaneGeometry_obj::uv( ::phoenix::Rectangle _rect){
{
		...
		if ((tmp1)){
			HX_STACK_LINE(45)
			Dynamic tmp2 = hx::SourceInfo(HX_HCSTRING("PlaneGeometry.hx","\x70","\x16","\x7f","\xef"),45,HX_HCSTRING("phoenix.geometry.PlaneGeometry","\x51","\x3f","\x02","\x9e"),HX_HCSTRING("uv","\x61","\x66","\x00","\x00"));		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(45)
