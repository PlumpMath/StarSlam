...
HX_STACK_ARG(_options,"_options")
{
	...
	HX_STACK_LINE(116)
	{
		...
		if ((tmp2)){
			HX_STACK_LINE(116)
			::luxe::DebugError tmp3 = ::luxe::DebugError_obj::null_assertion(HX_HCSTRING("options was null (TextGeometry requires non-null options)","\x0b","\x09","\xa8","\xba"));		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(116)
...
bool TextGeometry_obj::update_sizes( ){
	...
	HX_STACK_LINE(285)
	{
		...
		HX_STACK_LINE(285)
		int tmp14 = HX_HCSTRING("\n","\x0a","\x00","\x00","\x00").length;		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(285)
		...
		if ((tmp15)){
			...
			{
				HX_STACK_LINE(285)
				::luxe::utils::unifill::InternalEncodingIter tmp16 = ::luxe::utils::unifill::InternalEncodingIter_obj::__new(drawn_text,(int)0,drawn_text.length);		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(285)
				::luxe::utils::unifill::InternalEncodingIter _g1 = tmp16;		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(285)
				while((true)){
					HX_STACK_LINE(285)
					bool tmp17 = (_g1->index < _g1->endIndex);		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(285)
					...
					HX_STACK_LINE(285)
					{
						...
						{
							HX_STACK_LINE(285)
							::luxe::utils::unifill::Utf8 tmp21 = ::luxe::utils::unifill::Utf8_obj::__new(_g1->string);		HX_STACK_VAR(tmp21,"tmp21");
							HX_STACK_LINE(285)
							::luxe::utils::unifill::Utf8 u = tmp21;		HX_STACK_VAR(u,"u");
							HX_STACK_LINE(285)
							{
								HX_STACK_LINE(285)
								int tmp22 = _g1->index;		HX_STACK_VAR(tmp22,"tmp22");
								HX_STACK_LINE(285)
					...
					{
						HX_STACK_LINE(285)
						::luxe::utils::unifill::Utf8 tmp21 = ::luxe::utils::unifill::Utf8_obj::__new(drawn_text);		HX_STACK_VAR(tmp21,"tmp21");
						HX_STACK_LINE(285)
						::luxe::utils::unifill::Utf8 u = tmp21;		HX_STACK_VAR(u,"u");
						HX_STACK_LINE(285)
						{
							...
							HX_STACK_LINE(285)
							{
								...
								HX_STACK_LINE(285)
								{
									...
									HX_STACK_LINE(285)
									int tmp25 = u->str.cca(tmp24);		HX_STACK_VAR(tmp25,"tmp25");
									HX_STACK_LINE(285)
								...
								HX_STACK_LINE(285)
								{
									...
									int tmp24 = i;		HX_STACK_VAR(tmp24,"tmp24");
									HX_STACK_LINE(285)
									Dynamic tmp25 = len;		HX_STACK_VAR(tmp25,"tmp25");
									HX_STACK_LINE(285)
									::String tmp26 = u->str.substr(tmp24,tmp25);		HX_STACK_VAR(tmp26,"tmp26");
									HX_STACK_LINE(285)
									::String s = tmp26;		HX_STACK_VAR(s,"s");
									HX_STACK_LINE(285)
									tmp22 = s;
								}
							}
							HX_STACK_LINE(285)
							::luxe::utils::unifill::Utf8 tmp23 = ::luxe::utils::unifill::Utf8_obj::__new(tmp22);		HX_STACK_VAR(tmp23,"tmp23");
							HX_STACK_LINE(285)
							::luxe::utils::unifill::Utf8 _this1 = tmp23;		HX_STACK_VAR(_this1,"_this1");
							HX_STACK_LINE(285)
							tmp20 = _this1->str;
						}
					}
			...
			HX_STACK_LINE(285)
			_lines = drawn_text.split(HX_HCSTRING("\n","\x0a","\x00","\x00","\x00"));
		}
		HX_STACK_LINE(285)
		{
			HX_STACK_LINE(285)
			...
			while((true)){
				HX_STACK_LINE(285)
				bool tmp16 = (_g < _lines->length);		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(285)
				...
				HX_STACK_LINE(285)
				::String tmp18 = _lines->__get(_g);		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(285)
				::String _line = tmp18;		HX_STACK_VAR(_line,"_line");
				HX_STACK_LINE(285)
				++(_g);
				HX_STACK_LINE(285)
				::String tmp19 = _line;		HX_STACK_VAR(tmp19,"tmp19");
				HX_STACK_LINE(285)
				Float tmp20 = _point_size;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(285)
				Float tmp21 = _letter_spc;		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(285)
				Float tmp22 = _this->width_of_line(tmp19,tmp20,tmp21);		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(285)
				Float _cur_w = tmp22;		HX_STACK_VAR(_cur_w,"_cur_w");
				HX_STACK_LINE(285)
				Float tmp23 = _max_w;		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(285)
				Float tmp24 = _cur_w;		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(285)
				Float tmp25 = ::Math_obj::max(tmp23,tmp24);		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(285)
				_max_w = tmp25;
				HX_STACK_LINE(285)
				bool tmp26 = _push_widths;		HX_STACK_VAR(tmp26,"tmp26");
				HX_STACK_LINE(285)
				if ((tmp26)){
					HX_STACK_LINE(285)
					Float tmp27 = _cur_w;		HX_STACK_VAR(tmp27,"tmp27");
					HX_STACK_LINE(285)
					_line_widths->push(tmp27);
				}
			}
		}
		HX_STACK_LINE(285)
...
Void TextGeometry_obj::update_text( ){
{
		...
		HX_STACK_LINE(322)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(379)
				for(::cpp::FastIterator_obj< int > *__it = ::cpp::CreateFastIterator< int >(tmp10);  __it->hasNext(); ){
					int _uglyph = __it->next();
					{
						...
						::phoenix::BitmapFont tmp11 = this->font;		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(382)
						::haxe::ds::IntMap tmp12 = tmp11->info->__Field(HX_HCSTRING("chars","\xdd","\x9c","\xb3","\x45"), hx::paccDynamic );		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(382)
						int tmp13 = _index;		HX_STACK_VAR(tmp13,"tmp13");
						HX_STACK_LINE(382)
						Dynamic tmp14 = tmp12->get(tmp13);		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(382)
						Dynamic _char = tmp14;		HX_STACK_VAR(_char,"_char");
						HX_STACK_LINE(383)
						bool tmp15 = (_char != null());		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(383)
						...
						_is_char = tmp16;
						HX_STACK_LINE(387)
						bool tmp17 = _is_char;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(387)
						bool tmp18 = !(tmp17);		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(387)
						if ((tmp18)){
							HX_STACK_LINE(388)
							::phoenix::BitmapFont tmp19 = this->font;		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(388)
							_char = tmp19->space_char;
						}
						HX_STACK_LINE(391)
						...
						if ((tmp19)){
							HX_STACK_LINE(394)
							Float tmp20 = (_line_x_offset + _cur_x);		HX_STACK_VAR(tmp20,"tmp20");
							HX_STACK_LINE(394)
							Float tmp21 = _char->__Field(HX_HCSTRING("xoffset","\x0b","\x42","\x4f","\xde"), hx::paccDynamic );		HX_STACK_VAR(tmp21,"tmp21");
							HX_STACK_LINE(394)
							Float tmp22 = this->point_ratio;		HX_STACK_VAR(tmp22,"tmp22");
							HX_STACK_LINE(394)
							Float tmp23 = (tmp21 * tmp22);		HX_STACK_VAR(tmp23,"tmp23");
							HX_STACK_LINE(394)
							Float tmp24 = (tmp20 + tmp23);		HX_STACK_VAR(tmp24,"tmp24");
							HX_STACK_LINE(394)
							Float _quad_x = tmp24;		HX_STACK_VAR(_quad_x,"_quad_x");
							HX_STACK_LINE(395)
							Float tmp25 = (_line_y_offset + _cur_y);		HX_STACK_VAR(tmp25,"tmp25");
							HX_STACK_LINE(395)
							Float tmp26 = _char->__Field(HX_HCSTRING("yoffset","\xcc","\xb8","\xe4","\x07"), hx::paccDynamic );		HX_STACK_VAR(tmp26,"tmp26");
							HX_STACK_LINE(395)
							Float tmp27 = this->point_ratio;		HX_STACK_VAR(tmp27,"tmp27");
							HX_STACK_LINE(395)
							Float tmp28 = (tmp26 * tmp27);		HX_STACK_VAR(tmp28,"tmp28");
							HX_STACK_LINE(395)
							Float tmp29 = (tmp25 + tmp28);		HX_STACK_VAR(tmp29,"tmp29");
							HX_STACK_LINE(395)
							Float _quad_y = tmp29;		HX_STACK_VAR(_quad_y,"_quad_y");
							HX_STACK_LINE(397)
							::phoenix::BitmapFont tmp30 = this->font;		HX_STACK_VAR(tmp30,"tmp30");
							HX_STACK_LINE(397)
							int tmp31 = _char->__Field(HX_HCSTRING("page","\x4f","\xda","\x51","\x4a"), hx::paccDynamic );		HX_STACK_VAR(tmp31,"tmp31");
							HX_STACK_LINE(397)
							::phoenix::Texture tmp32 = tmp30->pages->get(tmp31);		HX_STACK_VAR(tmp32,"tmp32");
							HX_STACK_LINE(397)
							::phoenix::Texture _page = tmp32;		HX_STACK_VAR(_page,"_page");
							HX_STACK_LINE(399)
							Float tmp33 = (Float(_char->__Field(HX_HCSTRING("x","\x78","\x00","\x00","\x00"), hx::paccDynamic )) / Float(_page->width_actual));		HX_STACK_VAR(tmp33,"tmp33");
							HX_STACK_LINE(399)
							Float _u1 = tmp33;		HX_STACK_VAR(_u1,"_u1");
							HX_STACK_LINE(400)
							Float tmp34 = (Float(_char->__Field(HX_HCSTRING("y","\x79","\x00","\x00","\x00"), hx::paccDynamic )) / Float(_page->height_actual));		HX_STACK_VAR(tmp34,"tmp34");
							HX_STACK_LINE(400)
							Float _v1 = tmp34;		HX_STACK_VAR(_v1,"_v1");
							HX_STACK_LINE(401)
							Float tmp35 = (_char->__Field(HX_HCSTRING("x","\x78","\x00","\x00","\x00"), hx::paccDynamic ) + _char->__Field(HX_HCSTRING("width","\x06","\xb6","\x62","\xca"), hx::paccDynamic ));		HX_STACK_VAR(tmp35,"tmp35");
							HX_STACK_LINE(401)
							int tmp36 = _page->width_actual;		HX_STACK_VAR(tmp36,"tmp36");
							HX_STACK_LINE(401)
							Float tmp37 = (Float(tmp35) / Float(tmp36));		HX_STACK_VAR(tmp37,"tmp37");
							HX_STACK_LINE(401)
							Float _u2 = tmp37;		HX_STACK_VAR(_u2,"_u2");
							HX_STACK_LINE(402)
							Float tmp38 = (_char->__Field(HX_HCSTRING("y","\x79","\x00","\x00","\x00"), hx::paccDynamic ) + _char->__Field(HX_HCSTRING("height","\xe7","\x07","\x4c","\x02"), hx::paccDynamic ));		HX_STACK_VAR(tmp38,"tmp38");
							HX_STACK_LINE(402)
							int tmp39 = _page->height_actual;		HX_STACK_VAR(tmp39,"tmp39");
							HX_STACK_LINE(402)
							Float tmp40 = (Float(tmp38) / Float(tmp39));		HX_STACK_VAR(tmp40,"tmp40");
							HX_STACK_LINE(402)
							Float _v2 = tmp40;		HX_STACK_VAR(_v2,"_v2");
							HX_STACK_LINE(404)
							int tmp41 = _total_idx;		HX_STACK_VAR(tmp41,"tmp41");
							HX_STACK_LINE(405)
							Float tmp42 = _quad_x;		HX_STACK_VAR(tmp42,"tmp42");
							HX_STACK_LINE(405)
							Float tmp43 = _quad_y;		HX_STACK_VAR(tmp43,"tmp43");
							HX_STACK_LINE(405)
							Float tmp44 = _char->__Field(HX_HCSTRING("width","\x06","\xb6","\x62","\xca"), hx::paccDynamic );		HX_STACK_VAR(tmp44,"tmp44");
							HX_STACK_LINE(405)
							Float tmp45 = this->point_ratio;		HX_STACK_VAR(tmp45,"tmp45");
							HX_STACK_LINE(405)
							Float tmp46 = (tmp44 * tmp45);		HX_STACK_VAR(tmp46,"tmp46");
							HX_STACK_LINE(405)
							Float tmp47 = _char->__Field(HX_HCSTRING("height","\xe7","\x07","\x4c","\x02"), hx::paccDynamic );		HX_STACK_VAR(tmp47,"tmp47");
							HX_STACK_LINE(405)
							Float tmp48 = this->point_ratio;		HX_STACK_VAR(tmp48,"tmp48");
							HX_STACK_LINE(405)
							Float tmp49 = (tmp47 * tmp48);		HX_STACK_VAR(tmp49,"tmp49");
							HX_STACK_LINE(406)
							Float tmp50 = _u1;		HX_STACK_VAR(tmp50,"tmp50");
							HX_STACK_LINE(406)
							Float tmp51 = _v1;		HX_STACK_VAR(tmp51,"tmp51");
							HX_STACK_LINE(406)
							Float tmp52 = _u2;		HX_STACK_VAR(tmp52,"tmp52");
							HX_STACK_LINE(406)
							Float tmp53 = _v2;		HX_STACK_VAR(tmp53,"tmp53");
							HX_STACK_LINE(406)
							::phoenix::Color tmp54 = this->color;		HX_STACK_VAR(tmp54,"tmp54");
							HX_STACK_LINE(404)
							this->update_char(tmp41,tmp42,tmp43,tmp46,tmp49,tmp50,tmp51,tmp52,tmp53,tmp54);
							HX_STACK_LINE(410)
							(_total_idx)++;
						}
						HX_STACK_LINE(416)
						...
						HX_STACK_LINE(419)
						int tmp20 = _idx;		HX_STACK_VAR(tmp20,"tmp20");
						HX_STACK_LINE(419)
						int tmp21 = (_line.length - (int)1);		HX_STACK_VAR(tmp21,"tmp21");
						HX_STACK_LINE(419)
						...
						if ((tmp22)){
							...
							{
								HX_STACK_LINE(420)
								::String tmp24 = _line;		HX_STACK_VAR(tmp24,"tmp24");
								HX_STACK_LINE(420)
								int tmp25 = (_idx + (int)1);		HX_STACK_VAR(tmp25,"tmp25");
								HX_STACK_LINE(420)
								int tmp26 = ::haxe::Utf8_obj::charCodeAt(tmp24,tmp25);		HX_STACK_VAR(tmp26,"tmp26");
								HX_STACK_LINE(420)
								int _second = tmp26;		HX_STACK_VAR(_second,"_second");
								HX_STACK_LINE(420)
								::phoenix::BitmapFont tmp27 = this->font;		HX_STACK_VAR(tmp27,"tmp27");
								HX_STACK_LINE(420)
								::haxe::ds::IntMap tmp28 = tmp27->info->__Field(HX_HCSTRING("kernings","\x27","\xb8","\x8b","\x80"), hx::paccDynamic );		HX_STACK_VAR(tmp28,"tmp28");
								HX_STACK_LINE(420)
								int tmp29 = _index;		HX_STACK_VAR(tmp29,"tmp29");
								HX_STACK_LINE(420)
								::haxe::ds::IntMap tmp30 = tmp28->get(tmp29);		HX_STACK_VAR(tmp30,"tmp30");
								HX_STACK_LINE(420)
								...
								if ((tmp31)){
									HX_STACK_LINE(420)
									int tmp33 = _second;		HX_STACK_VAR(tmp33,"tmp33");
									HX_STACK_LINE(420)
							...
							HX_STACK_LINE(420)
							hx::AddEq(_x_inc,tmp23);
							HX_STACK_LINE(421)
							bool tmp24 = (_index >= (int)32);		HX_STACK_VAR(tmp24,"tmp24");
							HX_STACK_LINE(421)
							if ((tmp24)){
								HX_STACK_LINE(422)
								Float tmp25 = this->letter_spacing;		HX_STACK_VAR(tmp25,"tmp25");
								HX_STACK_LINE(422)
								hx::AddEq(_x_inc,tmp25);
							}
						}
						HX_STACK_LINE(426)
						Float tmp23 = this->point_ratio;		HX_STACK_VAR(tmp23,"tmp23");
						HX_STACK_LINE(426)
						hx::MultEq(_x_inc,tmp23);
						HX_STACK_LINE(429)
...
Float TextGeometry_obj::set_smoothness( Float s){
	...
	HX_STACK_LINE(623)
	::phoenix::Shader tmp1 = this->get_shader();		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(623)
	bool tmp2 = (tmp1 != null());		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(623)
	...
	if ((tmp5)){
		HX_STACK_LINE(624)
		::phoenix::Shader tmp6 = this->get_shader();		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(624)
		Float tmp7 = s;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(624)
		tmp6->set_float(HX_HCSTRING("smoothness","\xc5","\x37","\x00","\x93"),tmp7);
	}
	HX_STACK_LINE(627)
	Float tmp6 = this->smoothness = s;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(627)
	return tmp6;
}
...
Float TextGeometry_obj::set_thickness( Float s){
	...
	if ((tmp5)){
		...
		Float tmp7 = s;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(637)
		tmp6->set_float(HX_HCSTRING("thickness","\x74","\xf1","\x66","\x5a"),tmp7);
	}
	HX_STACK_LINE(640)
	Float tmp6 = this->thickness = s;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(640)
	return tmp6;
}
...
Float TextGeometry_obj::set_outline( Float s){
	...
	s = tmp1;
	HX_STACK_LINE(649)
	::phoenix::Shader tmp2 = this->get_shader();		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(649)
	bool tmp3 = (tmp2 != null());		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(649)
	...
	if ((tmp6)){
		HX_STACK_LINE(650)
		::phoenix::Shader tmp7 = this->get_shader();		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(650)
		Float tmp8 = s;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(650)
		tmp7->set_float(HX_HCSTRING("outline","\x82","\x17","\xbe","\xe1"),tmp8);
	}
	HX_STACK_LINE(653)
	Float tmp7 = this->outline = s;		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(653)
	return tmp7;
}
...
Float TextGeometry_obj::set_glow_threshold( Float s){
	...
	if ((tmp5)){
		...
		Float tmp7 = s;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(663)
		tmp6->set_float(HX_HCSTRING("glow_threshold","\x39","\x20","\x9c","\xba"),tmp7);
	}
	HX_STACK_LINE(666)
	Float tmp6 = this->glow_threshold = s;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(666)
	return tmp6;
}
...
Float TextGeometry_obj::set_glow_amount( Float s){
	...
	if ((tmp5)){
		...
		Float tmp7 = s;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(676)
		tmp6->set_float(HX_HCSTRING("glow_amount","\x8a","\x70","\x81","\x49"),tmp7);
	}
	HX_STACK_LINE(679)
	Float tmp6 = this->glow_amount = s;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(679)
	return tmp6;
}
...
::phoenix::Color TextGeometry_obj::set_outline_color( ::phoenix::Color c){
	...
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(686)
	::phoenix::Shader tmp = this->get_shader();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(686)
	bool tmp1 = (tmp != null());		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(686)
	...
	if ((tmp4)){
		HX_STACK_LINE(687)
		::phoenix::Shader tmp5 = this->get_shader();		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(687)
		::phoenix::Color tmp6 = c;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(687)
		tmp5->set_color(HX_HCSTRING("outline_color","\xa6","\x5d","\x13","\x96"),tmp6);
	}
	HX_STACK_LINE(690)
	::phoenix::Color tmp5 = this->outline_color = c;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(690)
	return tmp5;
}
...
::phoenix::Color TextGeometry_obj::set_glow_color( ::phoenix::Color c){
	...
	if ((tmp4)){
		...
		::phoenix::Color tmp6 = c;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(698)
		tmp5->set_color(HX_HCSTRING("glow_color","\xf1","\xee","\x6b","\xc3"),tmp6);
	}
	HX_STACK_LINE(701)
	::phoenix::Color tmp5 = this->glow_color = c;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(701)
	return tmp5;
}
...
Void TextGeometry_obj::flush_uniforms( ){
{
		...
		if ((tmp2)){
			HX_STACK_LINE(711)
			::phoenix::Shader tmp3 = this->get_shader();		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(711)
			Float tmp4 = this->smoothness;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(711)
			tmp3->set_float(HX_HCSTRING("smoothness","\xc5","\x37","\x00","\x93"),tmp4);
			HX_STACK_LINE(712)
			::phoenix::Shader tmp5 = this->get_shader();		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(712)
			Float tmp6 = this->thickness;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(712)
			tmp5->set_float(HX_HCSTRING("thickness","\x74","\xf1","\x66","\x5a"),tmp6);
			HX_STACK_LINE(713)
			::phoenix::Shader tmp7 = this->get_shader();		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(713)
			Float tmp8 = this->outline;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(713)
			tmp7->set_float(HX_HCSTRING("outline","\x82","\x17","\xbe","\xe1"),tmp8);
			HX_STACK_LINE(714)
			::phoenix::Shader tmp9 = this->get_shader();		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(714)
			Float tmp10 = this->glow_threshold;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(714)
			tmp9->set_float(HX_HCSTRING("glow_threshold","\x39","\x20","\x9c","\xba"),tmp10);
			HX_STACK_LINE(715)
			::phoenix::Shader tmp11 = this->get_shader();		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(715)
			Float tmp12 = this->glow_amount;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(715)
			tmp11->set_float(HX_HCSTRING("glow_amount","\x8a","\x70","\x81","\x49"),tmp12);
			HX_STACK_LINE(716)
			::phoenix::Shader tmp13 = this->get_shader();		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(716)
			::phoenix::Color tmp14 = this->outline_color;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(716)
			tmp13->set_color(HX_HCSTRING("outline_color","\xa6","\x5d","\x13","\x96"),tmp14);
			HX_STACK_LINE(717)
			::phoenix::Shader tmp15 = this->get_shader();		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(717)
			::phoenix::Color tmp16 = this->glow_color;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(717)
			tmp15->set_color(HX_HCSTRING("glow_color","\xf1","\xee","\x6b","\xc3"),tmp16);
		}
	}
return null();
}
