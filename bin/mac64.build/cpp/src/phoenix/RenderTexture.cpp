...
HX_STACK_ARG(_options,"_options")
{
	...
	HX_STACK_LINE(53)
	{
		...
		HX_STACK_LINE(53)
		::snow::modules::opengl::native::GL_FFI_obj::snow_gl_renderbuffer_storage((int)36161,(int)33189,tmp6,tmp7);
	}
	HX_STACK_LINE(55)
	{
		HX_STACK_LINE(55)
...
{
		HX_STACK_FRAME("phoenix.RenderTexture","clear",0xba007e05,"phoenix.RenderTexture.clear","phoenix/RenderTexture.hx",91,0xd65f2599)
		HX_STACK_THIS(this)
		HX_STACK_LINE(93)
		this->super::clear();
		HX_STACK_LINE(95)
...
{
		HX_STACK_FRAME("phoenix.RenderTexture","bindBuffer",0xb4215325,"phoenix.RenderTexture.bindBuffer","phoenix/RenderTexture.hx",105,0xd65f2599)
		HX_STACK_THIS(this)
		HX_STACK_LINE(107)
...
{
		HX_STACK_FRAME("phoenix.RenderTexture","unbindBuffer",0xcec7b4be,"phoenix.RenderTexture.unbindBuffer","phoenix/RenderTexture.hx",111,0xd65f2599)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("phoenix.RenderTexture","bindRenderBuffer",0xeaa600db,"phoenix.RenderTexture.bindRenderBuffer","phoenix/RenderTexture.hx",117,0xd65f2599)
		HX_STACK_THIS(this)
		HX_STACK_LINE(119)
		::phoenix::Renderer tmp = ::Luxe_obj::renderer;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(119)
...
{
		HX_STACK_FRAME("phoenix.RenderTexture","unbindRenderBuffer",0x021f1b34,"phoenix.RenderTexture.unbindRenderBuffer","phoenix/RenderTexture.hx",123,0xd65f2599)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_other,"_other")
		HX_STACK_LINE(125)
		::phoenix::Renderer tmp = ::Luxe_obj::renderer;		HX_STACK_VAR(tmp,"tmp");
