...
class HXCPP_CLASS_ATTRIBUTES  Input_obj : public hx::Interface{
	public:
		...
		virtual Void gamepad_add( int id)=0;
		virtual Dynamic gamepad_add_dyn()=0;
		virtual Void gamepad_remove( int id)=0;
		virtual Dynamic gamepad_remove_dyn()=0;
};
...
virtual Void gamepad_add( int id) { return mDelegate->gamepad_add(id);}  \
virtual Dynamic gamepad_add_dyn() { return mDelegate->gamepad_add_dyn();}  \
virtual Void gamepad_remove( int id) { return mDelegate->gamepad_remove(id);}  \
virtual Dynamic gamepad_remove_dyn() { return mDelegate->gamepad_remove_dyn();}  \
