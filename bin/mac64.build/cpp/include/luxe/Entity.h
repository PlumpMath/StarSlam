...
class HXCPP_CLASS_ATTRIBUTES  Entity_obj : public ::luxe::Objects_obj{
	...
	public:
		...
		virtual Void _windowmoved( Dynamic _event);
		Dynamic _windowmoved_dyn();

		virtual Void _windowresized( Dynamic _event);
		Dynamic _windowresized_dyn();

		virtual Void _windowsized( Dynamic _event);
		Dynamic _windowsized_dyn();

		virtual Void _windowminimized( Dynamic _event);
		Dynamic _windowminimized_dyn();

		virtual Void _windowrestored( Dynamic _event);
		...
		virtual ::luxe::structural::OrderedMap get_components( );
