...
class HXCPP_CLASS_ATTRIBUTES  Geometry_obj : public hx::Object{
	...
	public:
		...
		bool submitted;
		::snow::modules::opengl::native::GLBO static_vertex_buffer;
		::snow::modules::opengl::native::GLBO static_tcoord_buffer;
		::snow::modules::opengl::native::GLBO static_vcolor_buffer;
		::snow::modules::opengl::native::GLBO static_normal_buffer;
		bool added;
